...
- (void)configureChartWithRAREiWidget:(id<RAREiWidget>)context
  ...
  BOOL gray = [((CCPBVSettings_AppPreferences *) nil_chk([CCPBVUtils getPreferences])) getBooleanWithNSString:@"gray_charts" withBoolean:NO];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVaChartHandler = { "aChartHandler", "com.sparseware.bellavista", NULL, 0x401, 12, methods, 9, fields, 0, NULL};

...
+ (id<RAREiContainer>)createFormContainerWithRAREWindowViewer:(RAREWindowViewer *)w
  ...
  if (row != nil) {
    ...
    [((RARESPOTLabel *) nil_chk(l))->value_ setValueWithNSString:[CCPBVOrders getOrderDirectionsWithRARERenderableDataItem:row]];
  }
...
+ (id<RAREiContainer>)createFormContainerWithRAREWindowViewer:(RAREWindowViewer *)w
  ...
  l = (RARESPOTLabel *) check_class_cast([f findWidgetWithNSString:@"directions"], [RARESPOTLabel class]);
  [((RARESPOTLabel *) nil_chk(l))->value_ setValueWithNSString:[((RARERenderableDataItem *) nil_chk(order->directionsItem_)) description]];
...
+ (void)updateValueFromWidgetWithRAREiWidget:(id<RAREiWidget>)widget {
  ...
  }
  {
    ...
    switch ([type ordinal]) {
      ...
      for (id<RAREiWidget> __strong gw in nil_chk([g getWidgetList])) {
  ...
  @try {
    ...
    CCPBVOrderFields_FieldTypeEnum *type = [CCPBVOrderFields getFieldTypeWithRAREUTJSONObject:field];
    {
      ...
      switch ([type ordinal]) {
        ...
        case CCPBVOrderFields_FieldType_LIST:
        [((id<RAREiWidget>) nil_chk(widget)) setValueWithId:fv->value_];
        row = [((id<RAREiListHandler>) check_protocol_cast(widget, @protocol(RAREiListHandler))) getSelectedIndex];
        if (row != -1) {

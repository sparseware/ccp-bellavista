...
- (NSString *)valueToString {
  {
    ...
    switch ([[CCPBVOrderFields getFieldTypeWithRAREUTJSONObject:field_] ordinal]) {
      ...
      return [RAREFunctions convertDateTimeWithRAREiWidget:[RAREPlatform getWindowViewer] withId:value_ withBoolean:NO];
      case CCPBVOrderFields_FieldType_DATE:
      return [RAREFunctions convertDateWithRAREiWidget:[RAREPlatform getWindowViewer] withId:value_ withBoolean:NO];
      ...
      return [RAREFunctions convertDateWithRAREiWidget:[RAREPlatform getWindowViewer] withId:value_ withNSString:[((JavaTextSimpleDateFormat *) nil_chk(df)) toPattern]];
      default:

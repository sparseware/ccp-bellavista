...
static RARESPOTGridPane * CCPBVDocument_genericContainerCfg_;
...
+ (RARESPOTGridPane *)genericContainerCfg {
  return CCPBVDocument_genericContainerCfg_;
}

+ (void)setGenericContainerCfg:(RARESPOTGridPane *)genericContainerCfg {
  CCPBVDocument_genericContainerCfg_ = genericContainerCfg;
}
...
- (void)addAttachmentWithCCPBVDocument_DocumentItemTypeEnum:(CCPBVDocument_DocumentItemTypeEnum *)type
  ...
  [self addAttachmentWithCCPBVDocument_DocumentItemTypeEnum:type withJavaUtilDate:date withNSString:title withNSString:nil withNSString:nil withNSString:href];
}
...
+ (void)staticInitialize {
  CCPBVDocument_genericContainerCfg_ = (RARESPOTGridPane *) check_class_cast([((RAREWindowViewer *) nil_chk([RAREPlatform getWindowViewer])) createConfigurationObjectWithRAREActionLink:[[RAREActionLink alloc] initWithNSString:@"/generic_container.rml"]], [RARESPOTGridPane class]);
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVDocument = { "Document", "com.sparseware.bellavista", NULL, 0x1, 7, methods, 14, fields, 0, NULL};
...
- (CCPBVaAttachmentHandler *)getHandler {
  if (handler_ == nil) {
    handler_ = [CCPBVUtils getAttachmentHandlerWithCCPBVDocument_DocumentItemTypeEnum:itemType_];
  }
  return handler_;
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVDocument_DocumentItem = { "DocumentItem", "com.sparseware.bellavista", "Document", 0x9, 6, methods, 7, fields, 0, NULL};
...
+ (void)initialize {
  if (self == [CCPBVDocument_DocumentItemTypeEnum class]) {
    ...
    CCPBVDocument_DocumentItemTypeEnum_AUDIO = [[CCPBVDocument_DocumentItemTypeEnum alloc] initWithNSString:@"AUDIO" withInt:2];
    CCPBVDocument_DocumentItemTypeEnum_VIDEO = [[CCPBVDocument_DocumentItemTypeEnum alloc] initWithNSString:@"VIDEO" withInt:3];
    CCPBVDocument_DocumentItemTypeEnum_CUSTOM = [[CCPBVDocument_DocumentItemTypeEnum alloc] initWithNSString:@"CUSTOM" withInt:4];
    CCPBVDocument_DocumentItemTypeEnum_values = [[IOSObjectArray alloc] initWithObjects:(id[]){ CCPBVDocument_DocumentItemTypeEnum_DOCUMENT, CCPBVDocument_DocumentItemTypeEnum_IMAGE, CCPBVDocument_DocumentItemTypeEnum_AUDIO, CCPBVDocument_DocumentItemTypeEnum_VIDEO, CCPBVDocument_DocumentItemTypeEnum_CUSTOM, nil } count:5 type:[IOSClass classWithClass:[CCPBVDocument_DocumentItemTypeEnum class]]];
  }
}
  ...
  CCPBVDocument_DocumentItem *item = [((CCPBVDocument *) nil_chk(doc)) getAttachmentWithInt:n];
  {
    ...
    switch ([((CCPBVDocument_DocumentItem *) nil_chk(item))->itemType_ ordinal]) {
      ...
      if (handler == nil) {
        ...
        RAREGridPaneViewer *gp = (RAREGridPaneViewer *) check_class_cast([w createViewerWithRAREiWidget:sp withRARESPOTWidget:[CCPBVDocument genericContainerCfg]], [RAREGridPaneViewer class]);
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVDocument_AttachmentActionListener = { "AttachmentActionListener", "com.sparseware.bellavista", "Document", 0x8, 1, methods, 0, NULL, 0, NULL};

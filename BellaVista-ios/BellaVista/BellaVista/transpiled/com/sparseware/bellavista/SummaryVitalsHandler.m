...
@implementation ComSparsewareBellavistaSummaryVitalsHandler

static int ComSparsewareBellavistaSummaryVitalsHandler_DATE_COLUMN_POSITION_ = 0;
static int ComSparsewareBellavistaSummaryVitalsHandler_NAME_COLUMN_POSITION_ = 1;
static int ComSparsewareBellavistaSummaryVitalsHandler_VALUE_COLUMN_POSITION_ = 2;

+ (int)DATE_COLUMN_POSITION {
  return ComSparsewareBellavistaSummaryVitalsHandler_DATE_COLUMN_POSITION_;
}
...
+ (int)NAME_COLUMN_POSITION {
  return ComSparsewareBellavistaSummaryVitalsHandler_NAME_COLUMN_POSITION_;
}
...
+ (int)VALUE_COLUMN_POSITION {
  return ComSparsewareBellavistaSummaryVitalsHandler_VALUE_COLUMN_POSITION_;
}
...
- (void)calculateRangesAndUpdateUIWithRAREiFormViewer:(id<RAREiFormViewer>)fv
  ...
  (void) [vitals putWithId:@"bp" withId:[[ComSparsewareBellavistaSummaryVitalsHandler_BPVitalRange alloc] initWithRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"map" withId:[[ComSparsewareBellavistaSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"map" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"temp" withId:[[ComSparsewareBellavistaSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"temp" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"resp" withId:[[ComSparsewareBellavistaSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"resp" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"hr" withId:[[ComSparsewareBellavistaSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"hr" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"pulse" withId:[[ComSparsewareBellavistaSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"pulse" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  ...
  dateItem = [((RARERenderableDataItem *) nil_chk([rows getWithInt:0])) getWithInt:ComSparsewareBellavistaSummaryVitalsHandler_DATE_COLUMN_POSITION_];
  ...
  dateItem = [((RARERenderableDataItem *) nil_chk([rows getWithInt:len - 1])) getWithInt:ComSparsewareBellavistaSummaryVitalsHandler_DATE_COLUMN_POSITION_];
  [((RARERenderableDataItem *) nil_chk(dateItem)) setTypeWithInt:RARERenderableDataItem_TYPE_DATETIME];
  ...
  for (int i = 0; i < len; i++) {
    ...
    NSString *key = (NSString *) check_class_cast([((RARERenderableDataItem *) nil_chk([((RARERenderableDataItem *) nil_chk(row)) getWithInt:ComSparsewareBellavistaSummaryVitalsHandler_NAME_COLUMN_POSITION_])) getLinkedData], [NSString class]);
    ComSparsewareBellavistaSummaryVitalsHandler_VitalRange *vr = [vitals getWithId:key];
    if (vr == nil) {
      continue;
    }
    dateItem = [row getWithInt:ComSparsewareBellavistaSummaryVitalsHandler_DATE_COLUMN_POSITION_];
    [((RARERenderableDataItem *) nil_chk(dateItem)) setTypeWithInt:RARERenderableDataItem_TYPE_DATETIME];
    ...
    [((ComSparsewareBellavistaSummaryVitalsHandler_VitalRange *) nil_chk(vr)) addValueWithJavaUtilDate:date withNSString:[((RARERenderableDataItem *) nil_chk([row getWithInt:ComSparsewareBellavistaSummaryVitalsHandler_VALUE_COLUMN_POSITION_])) description]];
  }
...
- (void)onCreatedWithNSString:(NSString *)eventName
  ...
  RAREActionLink *link = [ComSparsewareBellavistaUtils createLinkWithRAREiWidget:widget withNSString:@"/hub/main/vitals/summary" withBoolean:YES];
...
- (void)updateFormWithRAREiContainer:(id<RAREiContainer>)fv
  ...
  id<RAREiWidget> label = [fv getWidgetWithNSString:@"vitals_description"];
  if (label != nil) {
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    ComSparsewareBellavistaSummaryVitalsHandler_VitalRange *vr = [vitals getWithId:name];
    if ([((JavaUtilHashSet *) nil_chk(chartVitals)) containsWithId:name]) {
      if ([((NSString *) nil_chk(name)) isEqual:@"bp"]) {
        ComSparsewareBellavistaSummaryVitalsHandler_VitalRange *map = [vitals getWithId:@"map"];
        if ([((ComSparsewareBellavistaSummaryVitalsHandler_VitalRange *) nil_chk(map)) hasValues]) {
          [((ComSparsewareBellavistaSummaryVitalsHandler_BPVitalRange *) check_class_cast(vr, [ComSparsewareBellavistaSummaryVitalsHandler_BPVitalRange class])) removeMapSeries];
          [((ComSparsewareBellavistaSummaryVitalsHandler_VitalRange *) nil_chk(vr)) addToChart];
          continue;
        }
      }
      [((ComSparsewareBellavistaSummaryVitalsHandler_VitalRange *) nil_chk(vr)) addToChart];
    }
    name = ((ComSparsewareBellavistaSummaryVitalsHandler_VitalRange *) nil_chk(vr))->name_;
    if (table != nil) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaSummaryVitalsHandler = { "SummaryVitalsHandler", "com.sparseware.bellavista", NULL, 0x1, 1, methods, 3, fields, 0, NULL};
  return &_ComSparsewareBellavistaSummaryVitalsHandler;
}

@end
@implementation ComSparsewareBellavistaSummaryVitalsHandler_VitalRange
...
- (id)initWithNSString:(NSString *)key
  ...
  if (self = [super init]) {
    ...
    if (chart != nil) {
      ...
      BOOL gray = [((JavaLangBoolean *) nil_chk([JavaLangBoolean getTRUE])) isEqual:[JavaLangBoolean valueOfWithBoolean:[((ComSparsewareBellavistaSettings_AppPreferences *) nil_chk([ComSparsewareBellavistaUtils getPreferences])) getBooleanWithNSString:@"gray_charts" withBoolean:NO]]];
      NSString *color = nil;
      if (attrs != nil) {
        if (gray) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaSummaryVitalsHandler_VitalRange = { "VitalRange", "com.sparseware.bellavista", "SummaryVitalsHandler", 0x8, 4, methods, 6, fields, 0, NULL};
  return &_ComSparsewareBellavistaSummaryVitalsHandler_VitalRange;
}

@end
@implementation ComSparsewareBellavistaSummaryVitalsHandler_BPVitalRange
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaSummaryVitalsHandler_BPVitalRange = { "BPVitalRange", "com.sparseware.bellavista", "SummaryVitalsHandler", 0x8, 0, NULL, 3, fields, 0, NULL};
  return &_ComSparsewareBellavistaSummaryVitalsHandler_BPVitalRange;
}

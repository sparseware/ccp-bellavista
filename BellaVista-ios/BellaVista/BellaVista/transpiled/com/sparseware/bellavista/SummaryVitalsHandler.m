...
@implementation CCPBVSummaryVitalsHandler

static int CCPBVSummaryVitalsHandler_DATE_COLUMN_POSITION_ = 0;
static int CCPBVSummaryVitalsHandler_NAME_COLUMN_POSITION_ = 1;
static int CCPBVSummaryVitalsHandler_VALUE_COLUMN_POSITION_ = 2;

+ (int)DATE_COLUMN_POSITION {
  return CCPBVSummaryVitalsHandler_DATE_COLUMN_POSITION_;
}
...
+ (int)NAME_COLUMN_POSITION {
  return CCPBVSummaryVitalsHandler_NAME_COLUMN_POSITION_;
}
...
+ (int)VALUE_COLUMN_POSITION {
  return CCPBVSummaryVitalsHandler_VALUE_COLUMN_POSITION_;
}
...
- (void)calculateRangesAndUpdateUIWithRAREiFormViewer:(id<RAREiFormViewer>)fv
  ...
  (void) [vitals putWithId:@"bp" withId:[[CCPBVSummaryVitalsHandler_BPVitalRange alloc] initWithRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"map" withId:[[CCPBVSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"map" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"temp" withId:[[CCPBVSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"temp" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"resp" withId:[[CCPBVSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"resp" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"hr" withId:[[CCPBVSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"hr" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  (void) [vitals putWithId:@"pulse" withId:[[CCPBVSummaryVitalsHandler_VitalRange alloc] initWithNSString:@"pulse" withRAREChartViewer:chart withRAREUTJSONObject:chartInfo]];
  ...
  dateItem = [((RARERenderableDataItem *) nil_chk([rows getWithInt:0])) getWithInt:CCPBVSummaryVitalsHandler_DATE_COLUMN_POSITION_];
  ...
  dateItem = [((RARERenderableDataItem *) nil_chk([rows getWithInt:len - 1])) getWithInt:CCPBVSummaryVitalsHandler_DATE_COLUMN_POSITION_];
  [((RARERenderableDataItem *) nil_chk(dateItem)) setTypeWithInt:RARERenderableDataItem_TYPE_DATETIME];
  ...
  for (int i = 0; i < len; i++) {
    ...
    NSString *key = (NSString *) check_class_cast([((RARERenderableDataItem *) nil_chk([((RARERenderableDataItem *) nil_chk(row)) getWithInt:CCPBVSummaryVitalsHandler_NAME_COLUMN_POSITION_])) getLinkedData], [NSString class]);
    CCPBVSummaryVitalsHandler_VitalRange *vr = [vitals getWithId:key];
    if (vr == nil) {
      continue;
    }
    dateItem = [row getWithInt:CCPBVSummaryVitalsHandler_DATE_COLUMN_POSITION_];
    [((RARERenderableDataItem *) nil_chk(dateItem)) setTypeWithInt:RARERenderableDataItem_TYPE_DATETIME];
    ...
    [((CCPBVSummaryVitalsHandler_VitalRange *) nil_chk(vr)) addValueWithJavaUtilDate:date withNSString:[((RARERenderableDataItem *) nil_chk([row getWithInt:CCPBVSummaryVitalsHandler_VALUE_COLUMN_POSITION_])) description]];
  }
...
- (void)updateFormWithRAREiContainer:(id<RAREiContainer>)fv
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    CCPBVSummaryVitalsHandler_VitalRange *vr = [vitals getWithId:name];
    if ([((JavaUtilHashSet *) nil_chk(chartVitals)) containsWithId:name]) {
      if ([((NSString *) nil_chk(name)) isEqual:@"bp"]) {
        CCPBVSummaryVitalsHandler_VitalRange *map = [vitals getWithId:@"map"];
        if ([((CCPBVSummaryVitalsHandler_VitalRange *) nil_chk(map)) hasValues]) {
          [((CCPBVSummaryVitalsHandler_BPVitalRange *) check_class_cast(vr, [CCPBVSummaryVitalsHandler_BPVitalRange class])) removeMapSeries];
          [((CCPBVSummaryVitalsHandler_VitalRange *) nil_chk(vr)) addToChart];
          continue;
        }
      }
      [((CCPBVSummaryVitalsHandler_VitalRange *) nil_chk(vr)) addToChart];
    }
    name = ((CCPBVSummaryVitalsHandler_VitalRange *) nil_chk(vr))->name_;
    if (table != nil) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVSummaryVitalsHandler = { "SummaryVitalsHandler", "com.sparseware.bellavista", NULL, 0x1, 1, methods, 3, fields, 0, NULL};
  return &_CCPBVSummaryVitalsHandler;
}

@end
@implementation CCPBVSummaryVitalsHandler_VitalRange
...
- (id)initWithNSString:(NSString *)key
  ...
  if (self = [super init]) {
    ...
    if (chart != nil) {
      ...
      BOOL gray = [((JavaLangBoolean *) nil_chk([JavaLangBoolean getTRUE])) isEqual:[JavaLangBoolean valueOfWithBoolean:[((CCPBVSettings_AppPreferences *) nil_chk([CCPBVUtils getPreferences])) getBooleanWithNSString:@"gray_charts" withBoolean:NO]]];
      NSString *color = nil;
      if (attrs != nil) {
        if (gray) {
...
- (void)copyAllFieldsTo:(CCPBVSummaryVitalsHandler_VitalRange *)other {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVSummaryVitalsHandler_VitalRange = { "VitalRange", "com.sparseware.bellavista", "SummaryVitalsHandler", 0x8, 4, methods, 6, fields, 0, NULL};
  return &_CCPBVSummaryVitalsHandler_VitalRange;
}

@end
@implementation CCPBVSummaryVitalsHandler_BPVitalRange
...
- (void)copyAllFieldsTo:(CCPBVSummaryVitalsHandler_BPVitalRange *)other {
  [super copyAllFieldsTo:other];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVSummaryVitalsHandler_BPVitalRange = { "BPVitalRange", "com.sparseware.bellavista", "SummaryVitalsHandler", 0x8, 0, NULL, 3, fields, 0, NULL};
  return &_CCPBVSummaryVitalsHandler_BPVitalRange;
}

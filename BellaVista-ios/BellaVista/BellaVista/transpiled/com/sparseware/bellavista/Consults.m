...
@implementation CCPBVConsults

static int CCPBVConsults_STATUS_COLUMN_ = 3;

+ (int)STATUS_COLUMN {
  return CCPBVConsults_STATUS_COLUMN_;
}
...
- (void)populateCardStackWithRAREiContainer:(id<RAREiContainer>)fv
  ...
  for (int i = 0; i < count; i++) {
    ...
    RARERenderableDataItem *item = [row getItemExWithInt:CCPBVConsults_STATUS_COLUMN_];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVConsults = { "Consults", "com.sparseware.bellavista", NULL, 0x1, 1, methods, 1, fields, 0, NULL};
  return &_CCPBVConsults;
}

@end
@implementation CCPBVConsults_OrdersStackActionListener
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LCCPBVConsults" },
  };
  static J2ObjcClassInfo _CCPBVConsults_OrdersStackActionListener = { "OrdersStackActionListener", "com.sparseware.bellavista", "Consults", 0x4, 0, NULL, 1, fields, 0, NULL};
  return &_CCPBVConsults_OrdersStackActionListener;
}

...
+ (void)setViewerInStackPaneViewerWithRAREStackPaneViewer:(RAREStackPaneViewer *)sp
  ...
  if (disposeOld) {
    id<RAREiFunctionCallback> cb = [[CCPBVUtils_$9 alloc] initWithRAREStackPaneViewer:sp];
...
+ (void)showDialogWithNSString:(NSString *)url
  ...
  @try {
    ...
    (void) [RAREViewerCreator createViewerWithRAREiWidget:w withRAREActionLink:link withRAREiFunctionCallback:[[CCPBVUtils_$10 alloc] initWithBoolean:decorated withBoolean:opaque]];
...
+ (void)showMainView {
  ...
  if (patient != nil) {
    ...
    if ((id_ != nil) && (name != nil)) {
      RAREWindowViewer *w = [RAREPlatform getWindowViewer];
      id<RAREiFunctionCallback> cb = [[CCPBVUtils_$11 alloc] initWithRAREWindowViewer:w];
      @try {
        RAREUTJSONObject *map = (RAREUTJSONObject *) check_class_cast([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDataWithId:@"user"], [RAREUTJSONObject class]);
  ...
  if (CCPBVUtils_protocolHandlers_ == nil) {
    ...
    if ((ph != nil) && ![ph isEmpty]) {
      ...
      while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
        ...
        if ([((NSString *) nil_chk(cls)) indexOf:'.'] == -1) {
          cls = [NSString stringWithFormat:@"%@.external.%@", [((JavaLangPackage *) nil_chk([[IOSClass classWithClass:[CCPBVUtils class]] getPackage])) getName], cls];
        }
...
+ (RAREUTJSONObject *)getContentAsJSONWithNSString:(NSString *)url
  ...
  NSString *s = (data == nil) ? [l getContentAsString] : [l sendFormDataWithRAREiWidget:[RAREPlatform getWindowViewer] withJavaUtilMap:data];
...
+ (JavaUtilDate *)parseDateWithNSString:(NSString *)value {
  @try {
    ...
    if ([JavaLangCharacter isDigitWithChar:[value charAtWithInt:0]]) {
      ...
      [RAREUTHelper setDateTimeWithNSString:value withJavaUtilCalendar:cal withBoolean:YES];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils = { "Utils", "com.sparseware.bellavista", NULL, 0x1, 53, methods, 37, fields, 0, NULL};
  return &_CCPBVUtils;
}
...
- (id)compute {
  ...
  @try {
    ...
    NSString *s;
    if (![CCPBVUtils demo]) {
      if ([CCPBVUtils protocolHandlers] != nil) {
        CCPBVaProtocolHandler *ph = [[CCPBVUtils protocolHandlers] getWithId:[((JavaNetURL *) nil_chk([((RAREActionLink *) nil_chk(l)) getURLWithRAREiWidget:window_])) getProtocol]];
        if (ph != nil) {
    ...
    (void) [CCPBVUtils setReloginConfig:(RARESPOTViewer *) check_class_cast([window_ createConfigurationObjectWithRAREActionLink:[[RAREActionLink alloc] initWithRAREiWidget:window_ withNSString:@"relogin.rml"]], [RARESPOTViewer class])];
...
- (void)run {
  ...
  [CCPBVUtils alertWithId:val$e_ withBoolean:![CCPBVUtils demo]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_$10 = { "$10", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 2, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_$11 = { "$11", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 1, fields, 0, NULL};

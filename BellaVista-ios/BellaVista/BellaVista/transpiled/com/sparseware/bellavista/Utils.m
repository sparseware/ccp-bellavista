...
static RAREUICompoundIcon * CCPBVUtils_backIcon_;
...
static id<RAREiPlatformIcon> CCPBVUtils_actionBarIcon_;
...
+ (RAREUICompoundIcon *)backIcon {
  return CCPBVUtils_backIcon_;
}

+ (void)setBackIcon:(RAREUICompoundIcon *)backIcon {
  CCPBVUtils_backIcon_ = backIcon;
}
...
+ (void)updateActionBar {
  if (![RAREUIScreen isLargeScreen]) {
    ...
    if (CCPBVUtils_actionBarTitle_ == nil) {
      ...
      CCPBVUtils_actionBarIcon_ = [((id<RAREiActionComponent>) nil_chk([((RAREActionBar *) nil_chk(ab)) getTitleComponent])) getIcon];
    }
...
+ (RAREActionLink *)createLinkWithRAREiWidget:(id<RAREiWidget>)context
  ...
  @try {
    ...
    [((RAREActionLink *) nil_chk(link)) setColumnSeparatorWithChar:CCPBVUtils_colSeparator_];
...
+ (void)exit {
  ...
  if (CCPBVUtils_applicationLock_ != nil || [CCPBVUtils getUserID] == nil) {
    if (![CCPBVOrderManager canExit]) {
      return;
    }
    [CCPBVUtils exitEx];
    return;
  ...
  id<RAREiFunctionCallback> cb = [[CCPBVUtils_$4 alloc] init];
...
+ (CCPBVaAttachmentHandler *)getAttachmentHandlerWithCCPBVDocument_DocumentItemTypeEnum:(CCPBVDocument_DocumentItemTypeEnum *)type {
  NSString *s = [((NSString *) nil_chk([((CCPBVDocument_DocumentItemTypeEnum *) nil_chk(type)) name])) lowercaseStringWithJRELocale:[JavaUtilLocale US]];
  ...
  if (s == nil || [s sequenceLength] == 0 || [s isEqual:@"default"]) {
    if (type == [CCPBVDocument_DocumentItemTypeEnum IMAGE]) {
...
+ (void)handleErrorWithJavaLangThrowable:(JavaLangThrowable *)ex {
  ...
  [RAREPlatform runOnUIThreadWithJavaLangRunnable:[[CCPBVUtils_$5 alloc] initWithJavaLangThrowable:e withRAREWindowViewer:w]];
}
...
+ (BOOL)popWorkspaceViewer {
  ...
  CCPBVUtils_StackEntry *e = [CCPBVUtils_stack_ removeWithInt:len - 1];
  if (((CCPBVUtils_StackEntry *) nil_chk(e))->viewer_ == nil) {
    ...
    if (icon == CCPBVUtils_backIcon_) {
      icon = [((RAREUICompoundIcon *) nil_chk(CCPBVUtils_backIcon_)) getSecondIcon];
      [CCPBVUtils_backIcon_ setSecondIconWithRAREiPlatformIcon:nil];
      [ab setTitleIconWithRAREiPlatformIcon:icon];
    }
    id<RAREiTarget> t = [w getTargetWithNSString:[RAREiTarget TARGET_WORKSPACE]];
    id<RAREiViewer> ov = [((id<RAREiTarget>) nil_chk(t)) setViewerWithRAREiViewer:e->viewer_];
    if ([CCPBVUtils isCardStack]) {
...
+ (void)pushWorkspaceViewerWithRAREiViewer:(id<RAREiViewer>)v {
  [CCPBVUtils pushWorkspaceViewerWithRAREiViewer:v withBoolean:NO];
}

+ (void)pushWorkspaceViewerWithRAREiViewer:(id<RAREiViewer>)v
                               withBoolean:(BOOL)disposible {
  if (CCPBVUtils_backIcon_ == nil) {
    CCPBVUtils_backIcon_ = [[RAREUICompoundIcon alloc] initWithRAREiPlatformIcon:[RAREPlatform getResourceAsIconWithNSString:@"bv.icon.back"] withRAREiPlatformIcon:nil];
  }
  RAREWindowViewer *w = [RAREPlatform getWindowViewer];
  RAREActionBar *ab = [((RAREWindowViewer *) nil_chk(w)) getActionBar];
  id<RAREiPlatformIcon> icon = [((id<RAREiActionComponent>) nil_chk([((RAREActionBar *) nil_chk(ab)) getTitleComponent])) getIcon];
  if (icon != CCPBVUtils_backIcon_) {
    [((RAREUICompoundIcon *) nil_chk(CCPBVUtils_backIcon_)) setSecondIconWithRAREiPlatformIcon:icon];
    [ab setTitleIconWithRAREiPlatformIcon:CCPBVUtils_backIcon_];
  }
  id<RAREiTarget> t = [w getTargetWithNSString:[RAREiTarget TARGET_WORKSPACE]];
  id<RAREiViewer> ov = [((id<RAREiTarget>) nil_chk(t)) removeViewer];
  CCPBVUtils_StackEntry *e = [[CCPBVUtils_StackEntry alloc] initWithRAREiViewer:ov];
...
+ (void)pushWorkspaceViewerWithNSString:(NSString *)url {
  [CCPBVUtils pushWorkspaceViewerWithNSString:url withBoolean:NO];
}

+ (void)pushWorkspaceViewerWithNSString:(NSString *)url
                            withBoolean:(BOOL)disposable {
  id<RAREiFunctionCallback> cb = [[CCPBVUtils_$6 alloc] initWithBoolean:disposable];
...
+ (void)setViewerInStackPaneViewerWithRAREStackPaneViewer:(RAREStackPaneViewer *)sp
  ...
  if (disposeOld) {
    id<RAREiFunctionCallback> cb = [[CCPBVUtils_$7 alloc] initWithRAREStackPaneViewer:sp];
...
+ (void)showDialogWithNSString:(NSString *)url
  ...
  @try {
    ...
    (void) [RAREViewerCreator createViewerWithRAREiWidget:w withRAREActionLink:link withRAREiFunctionCallback:[[CCPBVUtils_$8 alloc] initWithBoolean:decorated withBoolean:opaque]];
...
+ (void)showMainView {
  ...
  if (patient != nil) {
    ...
    if (id_ != nil && name != nil) {
      RAREWindowViewer *w = [RAREPlatform getWindowViewer];
      id<RAREiFunctionCallback> cb = [[CCPBVUtils_$9 alloc] initWithRAREWindowViewer:w];
      @try {
        RAREUTJSONObject *map = (RAREUTJSONObject *) check_class_cast([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDataWithId:@"user"], [RAREUTJSONObject class]);
  ...
  [CCPBVPatientSelect changePatientWithRAREiWidget:[app getTopWindowViewer] withCCPBVActionPath:nil];
}
...
+ (void)showPickListWithNSString:(NSString *)title
  ...
  [CCPBVUtils showPickListWithNSString:title withRAREActionLink:dataUrl withJavaUtilList:nil withBoolean:supportListDblClick withRAREiFunctionCallback:callback withBoolean:onUiThread];
}
...
+ (void)showPickListWithNSString:(NSString *)title
       ...
       withRAREiFunctionCallback:(id<RAREiFunctionCallback>)callback
                     withBoolean:(BOOL)onUiThread {
  [CCPBVUtils showPickListWithNSString:title withRAREActionLink:nil withJavaUtilList:rows withBoolean:supportListDblClick withRAREiFunctionCallback:callback withBoolean:onUiThread];
}
...
+ (void)signInWithRAREiWidget:(id<RAREiWidget>)context
  ...
  NSString *href = ((CCPBVSettings_Server *) nil_chk(server))->serverURL_;
...
+ (void)showPickListWithNSString:(NSString *)title
  ...
  @try {
    ...
    (void) [RAREViewerCreator createViewerWithRAREiWidget:w withRAREActionLink:link withRAREiFunctionCallback:[[CCPBVUtils_ShowPickListCallback alloc] initWithNSString:title withRAREActionLink:dataUrl withJavaUtilList:rows withBoolean:supportListDblClick withRAREiFunctionCallback:callback withBoolean:onUiThread]];
    [((RAREWindowViewer *) nil_chk([RAREPlatform getWindowViewer])) showWaitCursor];
  }
  @catch (JavaIoIOException *e) {
    [CCPBVUtils handleErrorWithJavaLangThrowable:e];
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getAttachmentHandlerWithCCPBVDocument_DocumentItemTypeEnum:", NULL, "LCCPBVaAttachmentHandler", 0x9, NULL },
    ...
    { "pushWorkspaceViewerWithNSString:withBoolean:", NULL, "V", 0x9, "JavaNetMalformedURLException" },
  ...
  static J2ObjcClassInfo _CCPBVUtils = { "Utils", "com.sparseware.bellavista", NULL, 0x1, 42, methods, 34, fields, 0, NULL};
  return &_CCPBVUtils;
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_StackEntry = { "StackEntry", "com.sparseware.bellavista", "Utils", 0x9, 0, NULL, 3, fields, 0, NULL};
...
- (id)compute {
  ...
  @try {
    ...
    if ([CCPBVUtils cardStack] && ![CCPBVUtils demo]) {
      if (url_ == nil) {
        l = [((RAREWindowViewer *) nil_chk(window_)) createActionLinkWithId:@"/hub/main/account/pin_login/user.json"];
      }
      else {
        l = [((RAREWindowViewer *) nil_chk(window_)) createActionLinkWithId:[[JavaNetURL alloc] initWithJavaNetURL:url_ withNSString:@"hub/main/account/pin_login/user.json"]];
      }
    }
    else {
      if (url_ == nil) {
    ...
    result = user;
    if (((CCPBVSettings_Server *) nil_chk(server_))->isContextServer_) {
      if (url_ != nil) {
    ...
    (void) [CCPBVUtils setReloginConfig:(RARESPOTViewer *) check_class_cast([((RAREWindowViewer *) nil_chk(window_)) createConfigurationObjectWithRAREActionLink:[[RAREActionLink alloc] initWithRAREiWidget:window_ withNSString:@"relogin.rml"]], [RARESPOTViewer class])];
    (void) [CCPBVUtils setGenericContainerCfg:(RARESPOTGridPane *) check_class_cast([window_ createConfigurationObjectWithRAREActionLink:[[RAREActionLink alloc] initWithRAREiWidget:window_ withNSString:@"/generic_container.rml"]], [RARESPOTGridPane class])];
    if ([CCPBVUtils cardStack]) {
      RARESPOTViewer *cfg = (RARESPOTViewer *) check_class_cast([window_ createConfigurationObjectWithRAREActionLink:[[RAREActionLink alloc] initWithRAREiWidget:window_ withNSString:@"infobar.rml"]], [RARESPOTViewer class]);
...
- (void)finishedWithBoolean:(BOOL)canceled
  ...
  if (!canceled && [((JavaLangBoolean *) nil_chk([JavaLangBoolean getTRUE])) isEqual:returnValue]) {
    [RAREPlatform invokeLaterWithJavaLangRunnable:[[CCPBVUtils_$4_$1 alloc] init]];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcClassInfo _CCPBVUtils_$4 = { "$4", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 0, NULL, 0, NULL};
  return &_CCPBVUtils_$4;
}

@end
@implementation CCPBVUtils_$4_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcClassInfo _CCPBVUtils_$4_$1 = { "$1", "com.sparseware.bellavista", "Utils$$4", 0x8000, 0, NULL, 0, NULL, 0, NULL};
  return &_CCPBVUtils_$4_$1;
}
...
- (void)run {
  ...
  if ([val$e_ isKindOfClass:[CCPBVMessageException class]]) {
  ...
  [CCPBVUtils alertWithId:val$e_ withBoolean:YES];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_$5 = { "$5", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 2, fields, 0, NULL};
...
- (void)finishedWithBoolean:(BOOL)canceled
  ...
  if ([returnValue isKindOfClass:[JavaLangThrowable class]]) {
    ...
    [CCPBVUtils pushWorkspaceViewerWithRAREiViewer:(id<RAREiViewer>) check_protocol_cast(returnValue, @protocol(RAREiViewer)) withBoolean:val$disposable_];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_$6 = { "$6", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 1, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_$7 = { "$7", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 1, fields, 0, NULL};

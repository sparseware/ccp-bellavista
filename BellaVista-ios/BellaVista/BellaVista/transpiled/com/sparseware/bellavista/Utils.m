...
+ (void)applicationResumed {
  ...
  id<RAREiFunctionCallback> cb = [[CCPBVUtils_$1 alloc] initWithRAREWindowViewer:w];
  @try {
...
+ (void)exit {
  ...
  id<RAREiFunctionCallback> cb = [[CCPBVUtils_$2 alloc] init];
...
+ (void)handleErrorWithJavaLangThrowable:(JavaLangThrowable *)ex {
  ...
  [RAREPlatform runOnUIThreadWithJavaLangRunnable:[[CCPBVUtils_$3 alloc] initWithJavaLangThrowable:e withRAREWindowViewer:w]];
}
...
+ (BOOL)popWorkspaceViewer {
  ...
  (void) [t setViewerWithRAREiViewer:((CCPBVUtils_StackEntry *) nil_chk(e))->viewer_];
...
+ (void)setViewerInStackPaneViewerWithRAREStackPaneViewer:(RAREStackPaneViewer *)sp
  ...
  if (disposeOld) {
    id<RAREiFunctionCallback> cb = [[CCPBVUtils_$5 alloc] initWithRAREStackPaneViewer:sp];
...
+ (void)showDialogWithNSString:(NSString *)url
  ...
  @try {
    ...
    (void) [RAREViewerCreator createViewerWithRAREiWidget:w withRAREActionLink:link withRAREiFunctionCallback:[[CCPBVUtils_$6 alloc] initWithBoolean:decorated withBoolean:opaque]];
...
+ (void)showMainView {
  ...
  if (patient != nil) {
    ...
    if (id_ != nil && name != nil) {
      RAREWindowViewer *w = [RAREPlatform getWindowViewer];
      id<RAREiFunctionCallback> cb = [[CCPBVUtils_$7 alloc] initWithRAREWindowViewer:w];
      @try {
        RAREUTJSONObject *map = (RAREUTJSONObject *) check_class_cast([((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) getDataWithId:@"user"], [RAREUTJSONObject class]);
...
+ (void)toggleFullScreenWithBoolean:(BOOL)full {
  ...
  if (full) {
    ...
    [CCPBVPatientSelect resetActionBar];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils = { "Utils", "com.sparseware.bellavista", NULL, 0x1, 36, methods, 25, fields, 0, NULL};
  return &_CCPBVUtils;
}
...
- (void)logout {
  ...
  if (![CCPBVUtils isDemo] && ![CCPBVUtils isApplicationLocked]) {
    @try {
      ...
      JavaLangThread *t = [[JavaLangThread alloc] initWithJavaLangRunnable:[[CCPBVUtils_LoginManager_$1 alloc] initWithRAREActionLink:l]];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_LoginManager_$1 = { "$1", "com.sparseware.bellavista", "Utils$LoginManager", 0x8000, 0, NULL, 1, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_$1 = { "$1", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 1, fields, 0, NULL};
...
- (void)finishedWithBoolean:(BOOL)canceled
  ...
  if (!canceled && [((JavaLangBoolean *) nil_chk([JavaLangBoolean getTRUE])) isEqual:returnValue]) {
    [RAREPlatform invokeLaterWithJavaLangRunnable:[[CCPBVUtils_$2_$1 alloc] init]];
  }
}
...
@end
@implementation CCPBVUtils_$2_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcClassInfo _CCPBVUtils_$2_$1 = { "$1", "com.sparseware.bellavista", "Utils$$2", 0x8000, 0, NULL, 0, NULL, 0, NULL};
  return &_CCPBVUtils_$2_$1;
}
...
- (void)run {
  ...
  [((RAREWindowViewer *) nil_chk(val$w_)) alertWithId:val$e_ withRAREiFunctionCallback:[[CCPBVUtils_$3_$1 alloc] init]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_$3 = { "$3", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 2, fields, 0, NULL};
  return &_CCPBVUtils_$3;
}

@end
@implementation CCPBVUtils_$3_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcClassInfo _CCPBVUtils_$3_$1 = { "$1", "com.sparseware.bellavista", "Utils$$3", 0x8000, 0, NULL, 0, NULL, 0, NULL};
  return &_CCPBVUtils_$3_$1;
}
...
- (void)finishedWithBoolean:(BOOL)canceled
  ...
  if ([returnValue isKindOfClass:[JavaLangThrowable class]]) {
    ...
    [CCPBVUtils pushWorkspaceViewerWithRAREiViewer:(id<RAREiViewer>) check_protocol_cast(returnValue, @protocol(RAREiViewer))];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVUtils_$5 = { "$5", "com.sparseware.bellavista", "Utils", 0x8000, 0, NULL, 1, fields, 0, NULL};

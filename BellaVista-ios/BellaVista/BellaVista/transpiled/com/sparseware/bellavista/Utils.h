...
@interface CCPBVUtils_StackEntry : NSObject {
 @public
...
J2OBJC_FIELD_SETTER(CCPBVUtils_StackEntry, url_, NSString *)
...
J2OBJC_FIELD_SETTER(CCPBVUtils_LoginManager_$1, val$l_, RAREActionLink *)
...
@interface CCPBVUtils_$1 : NSObject < RAREiFunctionCallback > {
 @public
...
J2OBJC_FIELD_SETTER(CCPBVUtils_$1, val$w_, RAREWindowViewer *)
...
@interface CCPBVUtils_$2_$1 : NSObject < JavaLangRunnable > {
}
...
@interface CCPBVUtils_$3 : NSObject < JavaLangRunnable > {
 @public
...
J2OBJC_FIELD_SETTER(CCPBVUtils_$3, val$e_, JavaLangThrowable *)
J2OBJC_FIELD_SETTER(CCPBVUtils_$3, val$w_, RAREWindowViewer *)

@interface CCPBVUtils_$3_$1 : NSObject < RAREiFunctionCallback > {
}
...
J2OBJC_FIELD_SETTER(CCPBVUtils_$5, val$sp_, RAREStackPaneViewer *)
...
J2OBJC_FIELD_SETTER(CCPBVUtils_$7, val$w_, RAREWindowViewer *)

...
@implementation ComSparsewareBellavistaSettings

- (id)init {
  if (self = [super init]) {
    (void) [ComSparsewareBellavistaUtils setSettingsHandler:self];
    preferences_ = [[ComSparsewareBellavistaSettings_AppPreferences alloc] init];
  }
  return self;
}

- (ComSparsewareBellavistaSettings_AppPreferences *)getAppPreferencesWithNSString:(NSString *)user {
  [((ComSparsewareBellavistaSettings_AppPreferences *) nil_chk(preferences_)) setUserWithNSString:user];
  return preferences_;
}

- (NSString *)getLastLoggedinUser {
  return [((ComSparsewareBellavistaSettings_AppPreferences *) nil_chk(preferences_)) getLastLoggedinUser];
}
...
- (void)onCheckBoxActionWithNSString:(NSString *)eventName
                     withRAREiWidget:(id<RAREiWidget>)widget
             withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [((ComSparsewareBellavistaSettings_AppPreferences *) nil_chk(preferences_)) putBooleanWithNSString:[((id<RAREiWidget>) nil_chk(widget)) getName] withBoolean:[widget isSelected]];
}
...
- (void)onCloseWithNSString:(NSString *)eventName
  ...
  [((ComSparsewareBellavistaSettings_AppPreferences *) nil_chk(preferences_)) setServersWithJavaUtilList:servers_];
  [preferences_ update];
...
- (void)onConfigureBasicSettingsWithNSString:(NSString *)eventName
  ...
  for (id<RAREiWidget> __strong w in nil_chk([((id<RAREiContainer>) nil_chk(fv)) getWidgetList])) {
    switch ([[((id<RAREiWidget>) nil_chk(w)) getWidgetType] ordinal]) {
      ...
      [w setSelectedWithBoolean:[((ComSparsewareBellavistaSettings_AppPreferences *) nil_chk(preferences_)) getBooleanWithNSString:[w getName] withBoolean:NO]];
      break;
      default:
      break;
    }
...
- (void)onConfigureLoginComboBoxWithNSString:(NSString *)eventName
  ...
  servers_ = [((ComSparsewareBellavistaSettings_AppPreferences *) nil_chk(preferences_)) getServers];
  for (ComSparsewareBellavistaSettings_Server * __strong s in nil_chk(servers_)) {
    [((RAREaListWidget *) nil_chk(lw)) addExWithRARERenderableDataItem:[[RARERenderableDataItem alloc] initWithNSString:((ComSparsewareBellavistaSettings_Server *) nil_chk(s))->serverName_ withId:s withRAREiPlatformIcon:nil]];
  }
  ComSparsewareBellavistaSettings_Server *s = [[ComSparsewareBellavistaSettings_Server alloc] initWithNSString:[RAREPlatform getResourceAsStringWithNSString:@"bv.text.local_demo"] withNSString:@"local" withBoolean:YES];
...
- (void)onConfigureServersWithNSString:(NSString *)eventName
  ...
  for (ComSparsewareBellavistaSettings_Server * __strong s in nil_chk(servers_)) {
    [((RAREaListViewer *) nil_chk(lv)) addExWithRARERenderableDataItem:[[RARERenderableDataItem alloc] initWithNSString:((ComSparsewareBellavistaSettings_Server *) nil_chk(s))->serverName_ withId:s withRAREiPlatformIcon:nil]];
  }
...
- (void)onServersAddActionWithNSString:(NSString *)eventName
  ...
  ComSparsewareBellavistaSettings_Server *s = [[ComSparsewareBellavistaSettings_Server alloc] initWithNSString:@"" withNSString:@"" withBoolean:NO];
  ...
  [RAREPlatform invokeLaterWithJavaLangRunnable:[[ComSparsewareBellavistaSettings_$1 alloc] initWithRAREiFormViewer:fv]];
}
...
- (void)onServersChangeWithNSString:(NSString *)eventName
  ...
  id<RAREiFormViewer> fv = [((id<RAREiWidget>) nil_chk(widget)) getFormViewer];
  RAREaListViewer *lv = (RAREaListViewer *) check_class_cast(widget, [RAREaListViewer class]);
  ComSparsewareBellavistaSettings_Server *s = (ComSparsewareBellavistaSettings_Server *) check_class_cast([lv getSelectionData], [ComSparsewareBellavistaSettings_Server class]);
  ...
  [((id<RAREiWidget>) nil_chk([fv getWidgetWithNSString:@"context"])) setSelectedWithBoolean:s == nil ? NO : s->isContextServer_];
  [((id<RAREiWidget>) nil_chk([fv getWidgetWithNSString:@"update"])) setEnabledWithBoolean:s != nil];
}
...
- (void)onServersDeleteActionWithNSString:(NSString *)eventName
  ...
  ComSparsewareBellavistaSettings_Server *s = (ComSparsewareBellavistaSettings_Server *) check_class_cast([((RAREaListViewer *) nil_chk(lv)) getSelectionData], [ComSparsewareBellavistaSettings_Server class]);
  if (s != nil) {
...
- (void)onServersUnloadWithNSString:(NSString *)eventName
  ...
  if (lv != nil) {
    ...
    int len = [lv size];
    for (int i = 0; i < len; i++) {
      [servers_ addWithId:(ComSparsewareBellavistaSettings_Server *) check_class_cast([((RARERenderableDataItem *) nil_chk([lv getWithInt:i])) getLinkedData], [ComSparsewareBellavistaSettings_Server class])];
    }
  }
}
...
- (void)onServersUpdateActionWithNSString:(NSString *)eventName
  ...
  if (n != -1) {
    ...
    ComSparsewareBellavistaSettings_Server *s = (ComSparsewareBellavistaSettings_Server *) check_class_cast([((RARERenderableDataItem *) nil_chk(item)) getLinkedData], [ComSparsewareBellavistaSettings_Server class]);
    ((ComSparsewareBellavistaSettings_Server *) nil_chk(s))->serverName_ = [((id<RAREiWidget>) nil_chk([fv getWidgetWithNSString:@"name"])) getValueAsString];
    s->serverURL_ = [((NSString *) nil_chk([((id<RAREiWidget>) nil_chk([fv getWidgetWithNSString:@"url"])) getValueAsString])) trim];
    s->isContextServer_ = [((id<RAREiWidget>) nil_chk([fv getWidgetWithNSString:@"context"])) isSelected];
...
- (void)saveLastLoggedinUserWithNSString:(NSString *)username {
  [((ComSparsewareBellavistaSettings_AppPreferences *) nil_chk(preferences_)) saveLastLoggedinUserWithNSString:username];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "getAppPreferencesWithNSString:", NULL, "LComSparsewareBellavistaSettings_AppPreferences", 0x1, NULL },
    { "getLastLoggedinUser", NULL, "LNSString", 0x1, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "preferences_", NULL, 0x0, "LComSparsewareBellavistaSettings_AppPreferences" },
    { "servers_", NULL, 0x0, "LJavaUtilList" },
    { "serversUpdated_", NULL, 0x0, "Z" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaSettings = { "Settings", "com.sparseware.bellavista", NULL, 0x1, 2, methods, 3, fields, 0, NULL};
  return &_ComSparsewareBellavistaSettings;
}

@end
@implementation ComSparsewareBellavistaSettings_AppPreferences

- (id)init {
  if (self = [super init]) {
    settings_ = [[JavaUtilHashMap alloc] init];
    NSString *path = [((JavaLangPackage *) nil_chk([[IOSClass classWithClass:[ComSparsewareBellavistaSettings class]] getPackage])) getName];
  ...
  if (servers_ == nil) {
    ...
    if (s != nil && [s sequenceLength] > 0) {
      ...
      while ((s = [sc nextTokenWithChar:0x0009]) != nil) {
        [list addWithId:[[ComSparsewareBellavistaSettings_Server alloc] initWithNSString:s]];
      }
      [sc close];
    }
    servers_ = list;
...
- (void)setServersWithJavaUtilList:(id<JavaUtilList>)list {
  ...
  if (list == nil || [list isEmpty]) {
    ...
    BOOL hasInvalid = NO;
    for (ComSparsewareBellavistaSettings_Server * __strong s in list) {
      if ([((ComSparsewareBellavistaSettings_Server *) nil_chk(s)) isValid]) {
    ...
    if (hasInvalid) {
      ...
      for (int i = len - 1; i > -1; i--) {
        if (![((ComSparsewareBellavistaSettings_Server *) nil_chk([list getWithInt:i])) isValid]) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaSettings_AppPreferences = { "AppPreferences", "com.sparseware.bellavista", "Settings", 0x9, 5, methods, 6, fields, 0, NULL};
  return &_ComSparsewareBellavistaSettings_AppPreferences;
}

@end
@implementation ComSparsewareBellavistaSettings_Server

- (id)initWithNSString:(NSString *)s {
  if (self = [super init]) {
    isContextServer_ = [((NSString *) nil_chk(s)) charAtWithInt:0] == '1';
    int n = [s indexOf:'^'];
    serverName_ = [s substring:1 endIndex:n];
    serverURL_ = [s substring:n + 1];
  }
  return self;
}
...
- (id)initWithNSString:(NSString *)serverName
  ...
  if (self = [super init]) {
    ...
    self->isContextServer_ = isContextServer;
  }
  return self;
}

- (BOOL)isValid {
  if (serverName_ == nil || [serverName_ sequenceLength] == 0 || serverURL_ == nil || ![serverURL_ hasPrefix:@"http"]) {
    return NO;
  }
  return YES;
}
...
- (JavaLangStringBuilder *)toStringWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:isContextServer_ ? @"1" : @"0"];
...
- (void)copyAllFieldsTo:(ComSparsewareBellavistaSettings_Server *)other {
  [super copyAllFieldsTo:other];
  other->isContextServer_ = isContextServer_;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "isContextServer_", NULL, 0x1, "Z" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaSettings_Server = { "Server", "com.sparseware.bellavista", "Settings", 0x9, 2, methods, 3, fields, 0, NULL};
  return &_ComSparsewareBellavistaSettings_Server;
}

@end
@implementation ComSparsewareBellavistaSettings_$1
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaSettings_$1 = { "$1", "com.sparseware.bellavista", "Settings", 0x8000, 0, NULL, 1, fields, 0, NULL};
  return &_ComSparsewareBellavistaSettings_$1;
}

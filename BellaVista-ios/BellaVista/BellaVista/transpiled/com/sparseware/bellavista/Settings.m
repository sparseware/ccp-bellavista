...
- (void)onServersAddActionWithNSString:(NSString *)eventName
  ...
  [RAREPlatform invokeLaterWithJavaLangRunnable:[[CCPBVSettings_$1 alloc] initWithRAREiFormViewer:fv]];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVSettings = { "Settings", "com.sparseware.bellavista", NULL, 0x1, 2, methods, 3, fields, 0, NULL};
  ...
  if (servers_ == nil) {
    ...
    if (s != nil && [s sequenceLength] > 0) {
      ...
      while ((s = [sc nextTokenWithChar:0x0009]) != nil) {
        [list addWithId:[[CCPBVSettings_Server alloc] initWithNSString:s]];
      }
      [sc close];
    }
    servers_ = list;
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVSettings_Server = { "Server", "com.sparseware.bellavista", "Settings", 0x9, 2, methods, 3, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVSettings_$1 = { "$1", "com.sparseware.bellavista", "Settings", 0x8000, 0, NULL, 1, fields, 0, NULL};

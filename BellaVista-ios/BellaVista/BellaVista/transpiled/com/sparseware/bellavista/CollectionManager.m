...
@implementation ComSparsewareBellavistaCollectionManager

static ComSparsewareBellavistaCollectionManager * ComSparsewareBellavistaCollectionManager_instance_;

+ (ComSparsewareBellavistaCollectionManager *)instance {
  return ComSparsewareBellavistaCollectionManager_instance_;
}

+ (void)setInstance:(ComSparsewareBellavistaCollectionManager *)instance {
  ComSparsewareBellavistaCollectionManager_instance_ = instance;
}
...
- (id)init {
  if (self = [super init]) {
    ...
    ComSparsewareBellavistaCollectionManager_instance_ = self;
    ...
    for (int i = 0; i < len; i++) {
      ...
      RAREActionLink *link = [ComSparsewareBellavistaUtils createLinkWithRAREiWidget:w withNSString:url withBoolean:NO];
      if (autoUpdate && ![ComSparsewareBellavistaUtils isDemo]) {
    ...
    for (int i = 0; i < len; i++) {
      ComSparsewareBellavistaCollectionManager_PatientList *pl = [[ComSparsewareBellavistaCollectionManager_PatientList alloc] initWithRAREUTJSONObject:[((RAREUTJSONArray *) nil_chk(list)) getJSONObjectWithInt:i] withRAREWindowViewer:w];
...
- (void)startPolling {
  paused_ = NO;
  if (!started_ && ![ComSparsewareBellavistaUtils isDemo]) {
    started_ = YES;
...
- (void)run {
  ...
  if (lastUpdate_ + quarterTime_ < time) {
    (void) [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) executeBackgroundTaskWithJavaLangRunnable:[[ComSparsewareBellavistaCollectionManager_$1 alloc] initWithComSparsewareBellavistaCollectionManager:self]];
  }
}
...
- (void)update {
  RAREWindowViewer *w = [RAREPlatform getWindowViewer];
  BOOL polled = NO;
  if (!paused_ && [ComSparsewareBellavistaUtils continuePollingForUpdates]) {
    id<JavaUtilIterator> it = [((id<JavaUtilSet>) nil_chk([((JavaUtilHashMap *) nil_chk(collections_)) entrySet])) iterator];
    while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
      id<JavaUtilMap_Entry> e = [it next];
      NSString *name = [((id<JavaUtilMap_Entry>) nil_chk(e)) getKey];
    ...
    [RAREPlatform invokeLaterWithJavaLangRunnable:[[ComSparsewareBellavistaCollectionManager_$2 alloc] initWithComSparsewareBellavistaCollectionManager:self withRAREWindowViewer:w]];
  }
  if (![((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) isShuttingDown]) {
    if (!polled && [ComSparsewareBellavistaUtils continuePollingForUpdates]) {
      @try {
        ...
        [ComSparsewareBellavistaUtils handleStatusObjectWithRAREUTJSONObject:o];
      }
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "getInstance", NULL, "LComSparsewareBellavistaCollectionManager", 0x9, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "updateInterval_", NULL, 0x0, "I" },
    { "lastUpdate_", NULL, 0x0, "J" },
    { "quarterTime_", NULL, 0x0, "I" },
    { "instance_", NULL, 0xa, "LComSparsewareBellavistaCollectionManager" },
    { "sounds_", NULL, 0x0, "LJavaUtilHashSet" },
    { "collections_", NULL, 0x0, "LJavaUtilHashMap" },
    { "paused_", NULL, 0x40, "Z" },
    { "started_", NULL, 0x0, "Z" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaCollectionManager = { "CollectionManager", "com.sparseware.bellavista", NULL, 0x1, 5, methods, 8, fields, 0, NULL};
  return &_ComSparsewareBellavistaCollectionManager;
}

@end
@implementation ComSparsewareBellavistaCollectionManager_PatientList
...
- (RAREActionLink *)getListLinkWithRAREiWidget:(id<RAREiWidget>)context
  ...
  return [ComSparsewareBellavistaUtils createLinkWithRAREiWidget:context withNSString:[self getListHREFWithNSString:id_] withBoolean:YES];
}

- (RAREActionLink *)getCollectionLinkWithRAREiWidget:(id<RAREiWidget>)context {
  return [ComSparsewareBellavistaUtils createLinkWithRAREiWidget:context withNSString:[self getCollectionHREF] withBoolean:YES];
}
...
- (id)initWithRAREUTJSONObject:(RAREUTJSONObject *)list
  ...
  if (self = [super init]) {
    ...
    RAREActionLink *link;
    if (containPatients_) {
      link = [ComSparsewareBellavistaUtils createLinkWithRAREiWidget:w withNSString:[NSString stringWithFormat:@"/hub/main/util/patients/%@", patientsPath_] withBoolean:NO];
      ...
      link = [ComSparsewareBellavistaUtils createLinkWithRAREiWidget:w withNSString:[NSString stringWithFormat:@"/hub/main/util/lists/%@", listPath_] withBoolean:NO];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaCollectionManager_PatientList = { "PatientList", "com.sparseware.bellavista", "CollectionManager", 0x8, 6, methods, 6, fields, 0, NULL};
  return &_ComSparsewareBellavistaCollectionManager_PatientList;
}

@end
@implementation ComSparsewareBellavistaCollectionManager_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LComSparsewareBellavistaCollectionManager" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaCollectionManager_$1 = { "$1", "com.sparseware.bellavista", "CollectionManager", 0x8000, 0, NULL, 1, fields, 0, NULL};
  return &_ComSparsewareBellavistaCollectionManager_$1;
}

@end
@implementation ComSparsewareBellavistaCollectionManager_$2

- (void)run {
  if (!this$0_->paused_ && [ComSparsewareBellavistaUtils continuePollingForUpdates]) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaCollectionManager_$2 = { "$2", "com.sparseware.bellavista", "CollectionManager", 0x8000, 0, NULL, 2, fields, 0, NULL};
  return &_ComSparsewareBellavistaCollectionManager_$2;
}

...
@implementation ComSparsewareBellavistaMainEventHandler

static id<JavaLangCharSequence> ComSparsewareBellavistaMainEventHandler_actionBarTitle_;
static id<RAREiPlatformIcon> ComSparsewareBellavistaMainEventHandler_actionBarIcon_;

+ (id<JavaLangCharSequence>)actionBarTitle {
  return ComSparsewareBellavistaMainEventHandler_actionBarTitle_;
}

+ (void)setActionBarTitle:(id<JavaLangCharSequence>)actionBarTitle {
  ComSparsewareBellavistaMainEventHandler_actionBarTitle_ = actionBarTitle;
}

+ (id<RAREiPlatformIcon>)actionBarIcon {
  return ComSparsewareBellavistaMainEventHandler_actionBarIcon_;
}

+ (void)setActionBarIcon:(id<RAREiPlatformIcon>)actionBarIcon {
  ComSparsewareBellavistaMainEventHandler_actionBarIcon_ = actionBarIcon;
}
...
- (void)onConfigureFlagsPopupWithNSString:(NSString *)eventName
                          withRAREiWidget:(id<RAREiWidget>)widget
                  withJavaUtilEventObject:(JavaUtilEventObject *)event {
  id<RAREiDataCollection> dc = [((ComSparsewareBellavistaCollectionManager *) nil_chk([ComSparsewareBellavistaCollectionManager getInstance])) getCollectionWithNSString:@"flags"];
  ...
  if (![lv isEmpty]) {
    ...
    [RAREPlatform invokeLaterWithJavaLangRunnable:[[ComSparsewareBellavistaMainEventHandler_$1 alloc] initWithRAREaListViewer:lv]];
  }
}
...
- (void)goBackInStackPaneWithNSString:(NSString *)eventName
                      withRAREiWidget:(id<RAREiWidget>)widget
              withJavaUtilEventObject:(JavaUtilEventObject *)event {
  RAREStackPaneViewer *sp = [ComSparsewareBellavistaUtils getStackPaneViewerWithRAREiWidget:widget];
  if (sp != nil) {
    int pos = [sp getEntryCount] - 1;
    if (pos > -1) {
      [sp switchToWithInt:pos - 1 withRAREiFunctionCallback:[[ComSparsewareBellavistaMainEventHandler_$2 alloc] initWithRAREStackPaneViewer:sp withInt:pos]];
    }
  }
}
...
- (void)onTabPaneCreatedWithNSString:(NSString *)eventName
                     withRAREiWidget:(id<RAREiWidget>)widget
             withJavaUtilEventObject:(JavaUtilEventObject *)event {
  ComSparsewareBellavistaActionPath *p = [ComSparsewareBellavistaUtils getActionPathWithBoolean:NO];
...
- (void)onConfigureInfoBarWithNSString:(NSString *)eventName
  ...
  if (ip != nil) {
    ...
    if (s != nil && [s sequenceLength] > 0) {
      @try {
        RAREActionLink *link = [ComSparsewareBellavistaUtils createPhotosActionLinkWithNSString:s withBoolean:NO];
        if (link != nil) {
          (void) [((RAREWindowViewer *) nil_chk([RAREPlatform getWindowViewer])) getContentWithRAREiWidget:ip withId:link withId:[RAREActionLink_ReturnDataTypeEnum IMAGE] withRAREiFunctionCallback:[[ComSparsewareBellavistaMainEventHandler_$3 alloc] initWithRAREImagePaneViewer:ip]];
        }
      }
      @catch (JavaNetMalformedURLException *e) {
  ...
  [((ComSparsewareBellavistaCollectionManager *) nil_chk([ComSparsewareBellavistaCollectionManager getInstance])) updateUI];
...
- (void)signInWithNSString:(NSString *)eventName
  ...
  if ([ComSparsewareBellavistaUtils isApplicationLocked]) {
    [ComSparsewareBellavistaUtils resignInWithRAREiWidget:widget withNSString:password];
  }
  else {
    NSString *username = [((id<RAREiWidget>) nil_chk([fv getWidgetWithNSString:@"username"])) getValueAsString];
    ComSparsewareBellavistaSettings_Server *server = (ComSparsewareBellavistaSettings_Server *) check_class_cast([((id<RAREiWidget>) nil_chk([fv getWidgetWithNSString:@"server"])) getSelectionData], [ComSparsewareBellavistaSettings_Server class]);
    [ComSparsewareBellavistaUtils signInWithRAREiWidget:widget withNSString:username withNSString:password withComSparsewareBellavistaSettings_Server:server];
  }
}

- (void)copyAllFieldsTo:(ComSparsewareBellavistaMainEventHandler *)other {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaMainEventHandler = { "MainEventHandler", "com.sparseware.bellavista", NULL, 0x1, 1, methods, 3, fields, 0, NULL};
  return &_ComSparsewareBellavistaMainEventHandler;
}

@end
@implementation ComSparsewareBellavistaMainEventHandler_$1
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaMainEventHandler_$1 = { "$1", "com.sparseware.bellavista", "MainEventHandler", 0x8000, 0, NULL, 1, fields, 0, NULL};
  return &_ComSparsewareBellavistaMainEventHandler_$1;
}

@end
@implementation ComSparsewareBellavistaMainEventHandler_$2
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaMainEventHandler_$2 = { "$2", "com.sparseware.bellavista", "MainEventHandler", 0x8000, 0, NULL, 2, fields, 0, NULL};
  return &_ComSparsewareBellavistaMainEventHandler_$2;
}

@end
@implementation ComSparsewareBellavistaMainEventHandler_$3
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaMainEventHandler_$3 = { "$3", "com.sparseware.bellavista", "MainEventHandler", 0x8000, 0, NULL, 1, fields, 0, NULL};
  return &_ComSparsewareBellavistaMainEventHandler_$3;
}

...
@implementation ComSparsewareBellavistaLabs

static int ComSparsewareBellavistaLabs_CATEGORY_NAME_POSITION_ = 6;
static int ComSparsewareBellavistaLabs_IS_DOCUMENT_POSITION_ = 5;
static int ComSparsewareBellavistaLabs_SORT_ORDER_POSITION_ = 8;
static int ComSparsewareBellavistaLabs_UNIT_POSITION_ = 3;
static int ComSparsewareBellavistaLabs_RESULT_ID_POSITION_ = 9;
static int ComSparsewareBellavistaLabs_COMMENT_POSITION_ = 10;
static JavaUtilLinkedHashMap * ComSparsewareBellavistaLabs_trendMap_;

+ (int)CATEGORY_NAME_POSITION {
  return ComSparsewareBellavistaLabs_CATEGORY_NAME_POSITION_;
}
...
+ (int)IS_DOCUMENT_POSITION {
  return ComSparsewareBellavistaLabs_IS_DOCUMENT_POSITION_;
}
...
+ (int)SORT_ORDER_POSITION {
  return ComSparsewareBellavistaLabs_SORT_ORDER_POSITION_;
}
...
+ (int)UNIT_POSITION {
  return ComSparsewareBellavistaLabs_UNIT_POSITION_;
}
...
+ (int)RESULT_ID_POSITION {
  return ComSparsewareBellavistaLabs_RESULT_ID_POSITION_;
}
...
+ (int)COMMENT_POSITION {
  return ComSparsewareBellavistaLabs_COMMENT_POSITION_;
}
...
+ (JavaUtilLinkedHashMap *)trendMap {
  return ComSparsewareBellavistaLabs_trendMap_;
}

+ (void)setTrendMap:(JavaUtilLinkedHashMap *)trendMap {
  ComSparsewareBellavistaLabs_trendMap_ = trendMap;
}

- (id)init {
  if (self = [super initWithNSString:@"labs" withNSString:@"Labs"]) {
    uniqueSummaryEntries_ = YES;
    ComSparsewareBellavistaLabs_trendMap_ = [[JavaUtilLinkedHashMap alloc] initWithInt:4];
    ...
    bunValue_ = (ComSparsewareBellavistaClinicalValue *) check_class_cast([((RAREUTJSONObject *) nil_chk(patient)) optWithNSString:@"cv_bun"], [ComSparsewareBellavistaClinicalValue class]);
    creatinineValue_ = (ComSparsewareBellavistaClinicalValue *) check_class_cast([patient optWithNSString:@"cv_creatinine"], [ComSparsewareBellavistaClinicalValue class]);
    bunID_ = bunValue_ == nil ? nil : [bunValue_ getID];
    creatineID_ = bunValue_ == nil ? nil : [((ComSparsewareBellavistaClinicalValue *) nil_chk(creatinineValue_)) getID];
    RAREUTJSONObject *info = (RAREUTJSONObject *) check_class_cast([app getDataWithId:@"labsInfo"], [RAREUTJSONObject class]);
    trendPanels_ = [self createTrendPanelsWithRAREUTJSONArray:[((RAREUTJSONObject *) nil_chk(info)) optJSONArrayWithNSString:@"trends"]];
    ...
    if (trendPanels_ != nil) {
      ...
      [ComSparsewareBellavistaTrendPanel setupLabelsWithRAREWindowViewer:[RAREPlatform getWindowViewer]];
    }
    currentView_ = [RAREUIScreen isLargeScreen] ? [ComSparsewareBellavistaResultsViewEnum TRENDS] : [ComSparsewareBellavistaResultsViewEnum CHARTS];
    chartHandler_ = [[ComSparsewareBellavistaLabs_ChartHandler alloc] initWithComSparsewareBellavistaLabs:self withRAREUTJSONObject:[info getJSONObjectWithNSString:@"charts"]];
...
- (ComSparsewareBellavistaActionPath *)getDisplayedActionPath {
  if (isSummary_) {
    return [[ComSparsewareBellavistaActionPath alloc] initWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ [ComSparsewareBellavistaUtils getPatientID], @"summary" } count:2 type:[IOSClass classWithClass:[NSString class]]]];
  }
...
- (void)filterTableWithRARERenderableDataItem:(RARERenderableDataItem *)filterItem {
  if (filterItem != nil) {
    ...
    if (currentView_ == [ComSparsewareBellavistaResultsViewEnum SPREADSHEET]) {
    ...
    if (all) {
      ...
      [table filterWithRAREUTiFilter:[[ComSparsewareBellavistaLabs_$1 alloc] initWithComSparsewareBellavistaLabs:self withNSString:cat]];
      if (![table isEmpty]) {
        [table scrollRowToTopWithInt:0];
      }
    }
...
- (BOOL)checkRowWithRARERenderableDataItem:(RARERenderableDataItem *)row
  ...
  @try {
    do {
      ...
      RARERenderableDataItem *valueItem = [row getItemExWithInt:ComSparsewareBellavistaLabs_IS_DOCUMENT_POSITION_];
      if ((valueItem != nil) && [@"true" isEqual:[valueItem getValue]]) {
        valueItem = [row getWithInt:[ComSparsewareBellavistaaResultsManager VALUE_POSITION]];
          ...
          if (trendPanels_ != nil) {
            {
              ...
              while (b__ < e__) {
                ComSparsewareBellavistaTrendPanel *p = (*b__++);
                if ([((ComSparsewareBellavistaTrendPanel *) nil_chk(p)) addTrendWithNSString:key withJavaUtilDate:date withRARERenderableDataItem:valueItem]) {
                  break;
                }
              }
            }
      ...
      if (!bunFound_ && [((NSString *) nil_chk(key)) isEqual:bunID_]) {
        bunFound_ = YES;
        date = (JavaUtilDate *) check_class_cast([((RARERenderableDataItem *) nil_chk([row getWithInt:[ComSparsewareBellavistaaResultsManager DATE_POSITION]])) getValue], [JavaUtilDate class]);
        [((ComSparsewareBellavistaClinicalValue *) nil_chk(bunValue_)) updateWithJavaUtilDate:date withNSString:value];
        if (creatFound_) {
          break;
        }
      }
...
- (ComSparsewareBellavistaActionPath *)getActionPath {
  ...
  ComSparsewareBellavistaActionPath *p = [[ComSparsewareBellavistaActionPath alloc] initWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"labs" } count:1 type:[IOSClass classWithClass:[NSString class]]]];
  [p addWithId:[((NSString *) nil_chk([((ComSparsewareBellavistaResultsViewEnum *) nil_chk(currentView_)) description])) lowercaseStringWithJRELocale:[JavaUtilLocale US]]];
  {
    RARETableViewer *table;
    switch ([currentView_ ordinal]) {
      case ComSparsewareBellavistaResultsView_CHARTS:
      case ComSparsewareBellavistaResultsView_DOCUMENT:
      row = [((RARETableViewer *) nil_chk(dataTable_)) getSelectedItem];
      if (row != nil) {
        [p addWithId:(NSString *) check_class_cast([((RARERenderableDataItem *) nil_chk([row getWithInt:[ComSparsewareBellavistaaResultsManager DATE_POSITION]])) getLinkedData], [NSString class])];
      }
      break;
      case ComSparsewareBellavistaResultsView_SPREADSHEET:
      ...
      if (table != nil) {
        ...
        if (row != nil) {
          [p addWithId:(NSString *) check_class_cast([((RARERenderableDataItem *) nil_chk([row getWithInt:0])) getLinkedData], [NSString class])];
        }
      }
      break;
      default:
...
- (void)onFinishedLoadingWithNSString:(NSString *)eventName
  ...
  id<RAREiWidget> cw = [((id<RAREiFormViewer>) nil_chk([((RARETableViewer *) nil_chk(table)) getFormViewer])) getWidgetWithNSString:@"categories"];
  if ([(id) cw isKindOfClass:[RAREaWidget class]]) {
    ...
    id<JavaUtilList> list = [ComSparsewareBellavistaUtils categorizeWithRARETableViewer:table withInt:ComSparsewareBellavistaLabs_CATEGORY_NAME_POSITION_ withRARERenderableDataItem:other withBoolean:sortCategoriesOnLinkedData_];
    ...
    [((RAREaWidget *) check_class_cast(cw, [RAREaWidget class])) addAllWithJavaUtilCollection:list];
    if ([(id) cw isKindOfClass:[RAREPushButtonWidget class]]) {
      [((RAREPushButtonWidget *) check_class_cast(cw, [RAREPushButtonWidget class])) setPopupScrollableWithBoolean:YES];
    }
    [((id<RAREiWidget>) nil_chk(cw)) update];
  }
  [ComSparsewareBellavistaUtils sortTableWithRARETableViewer:table withInt:ComSparsewareBellavistaLabs_SORT_ORDER_POSITION_];
}

- (void)onLabReportLoadWithNSString:(NSString *)eventName
                    withRAREiWidget:(id<RAREiWidget>)widget
            withJavaUtilEventObject:(JavaUtilEventObject *)event {
  RAREGridPaneViewer *gp = (RAREGridPaneViewer *) check_class_cast(widget, [RAREGridPaneViewer class]);
  ComSparsewareBellavistaDocument *doc = (ComSparsewareBellavistaDocument *) check_class_cast([((RAREGridPaneViewer *) nil_chk(gp)) getLinkedData], [ComSparsewareBellavistaDocument class]);
  if (doc != nil) {
    [gp setLinkedDataWithId:nil];
    RAREWindowViewer *w = [RAREPlatform getWindowViewer];
    RAREStackPaneViewer *sp = (RAREStackPaneViewer *) check_class_cast([gp getWidgetWithNSString:@"reportStack"], [RAREStackPaneViewer class]);
    RARENavigatorWidget *nw = (RARENavigatorWidget *) check_class_cast([gp getWidgetWithNSString:@"navigator"], [RARENavigatorWidget class]);
    BOOL stains = [self reportHasStainsWithComSparsewareBellavistaDocument:doc];
    BOOL sus = [self reportHasSusceptibilitiesWithComSparsewareBellavistaDocument:doc];
    if (!stains && !sus) {
      ...
      if (!sus) {
        ...
        [self loadSusceptibilitiesWithRAREWindowViewer:w withComSparsewareBellavistaDocument:doc withRARETableViewer:(RARETableViewer *) check_class_cast([((RAREStackPaneViewer *) nil_chk(sp)) getViewerWithInt:1], [RARETableViewer class])];
      }
      if (!stains) {
        [((RARENavigatorWidget *) nil_chk(nw)) setActionVisibleWithInt:2 withBoolean:NO];
      }
      else {
        [self loadStainsWithRAREWindowViewer:w withComSparsewareBellavistaDocument:doc withRAREiWidget:[((RAREStackPaneViewer *) nil_chk(sp)) getViewerWithInt:2]];
      }
    }
  }
}
...
- (void)onSummaryTableActionWithNSString:(NSString *)eventName
  ...
  ComSparsewareBellavistaActionPath *path = [[ComSparsewareBellavistaActionPath alloc] initWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"labs", key } count:2 type:[IOSClass classWithClass:[NSString class]]]];
...
- (void)onCreatedWithNSString:(NSString *)eventName
              withRAREiWidget:(id<RAREiWidget>)widget
      withJavaUtilEventObject:(JavaUtilEventObject *)event {
  ComSparsewareBellavistaActionPath *path = [ComSparsewareBellavistaUtils getActionPathWithBoolean:NO];
  if (path != nil && [path peek] != nil) {
    currentView_ = [ComSparsewareBellavistaResultsViewEnum CHARTS];
    if ([RAREUIScreen isLargeScreen]) {
  ...
  if (dataLoaded_ && trendPanels_ != nil) {
    {
      ...
      while (b__ < e__) {
        ComSparsewareBellavistaTrendPanel *p = (*b__++);
        [((ComSparsewareBellavistaTrendPanel *) nil_chk(p)) popuplateTableWithRARETableViewer:(RARETableViewer *) check_class_cast(widget, [RARETableViewer class]) withJavaUtilMap:trendsLayout_];
      }
    }
...
- (void)showChartForSelectedItemWithRARETableViewer:(RARETableViewer *)table {
  ...
  RARERenderableDataItem *item = (row == nil) ? nil : [row getItemExWithInt:ComSparsewareBellavistaLabs_IS_DOCUMENT_POSITION_];
  if ((item != nil) && [@"true" isEqual:[item getValue]]) {
    @try {
      RAREWindowViewer *w = [RAREPlatform getWindowViewer];
      item = [row getWithInt:ComSparsewareBellavistaLabs_RESULT_ID_POSITION_];
      ...
      RARESplitPaneViewer *sv = [ComSparsewareBellavistaUtils getSplitPaneViewerWithRAREiWidget:table];
      if (sv != nil) {
        id<RAREiTarget> t = [sv getRegionWithInt:1];
        [((RAREActionLink *) nil_chk(link)) setTargetNameWithNSString:[((id<RAREiTarget>) nil_chk(t)) getName]];
      }
      else {
        [((RAREActionLink *) nil_chk(link)) setTargetNameWithNSString:[RAREiTarget TARGET_WORKSPACE]];
      }
      ComSparsewareBellavistaDocument *doc = [[ComSparsewareBellavistaDocument alloc] initWithRAREiWidget:table withRAREActionLink:[[RAREActionLink alloc] initWithJavaNetURL:url] withNSString:id_];
      [doc setMainDocumentInfoWithJavaUtilDate:(JavaUtilDate *) check_class_cast([((RARERenderableDataItem *) nil_chk([row getWithInt:[ComSparsewareBellavistaaResultsManager DATE_POSITION]])) getValue], [JavaUtilDate class]) withNSString:[((RARERenderableDataItem *) nil_chk([row getWithInt:[ComSparsewareBellavistaaResultsManager NAME_POSITION]])) description]];
...
- (void)showCollectionInfoWithRARETableViewer:(RARETableViewer *)table
  ...
  @try {
    ...
    RAREUTJSONObject *json = (RAREUTJSONObject *) check_class_cast(o, [RAREUTJSONObject class]);
    (void) [RAREViewerCreator createConfigurationWithRAREiWidget:table withRAREActionLink:[[RAREActionLink alloc] initWithNSString:@"/lab_collection_info.rml"] withRAREiFunctionCallback:[[ComSparsewareBellavistaLabs_$2 alloc] initWithRAREWindowViewer:win withRARETableViewer:table withRAREUTJSONObject:json withRARERenderableDataItem:row]];
  }
  @catch (JavaLangException *e) {
    [ComSparsewareBellavistaUtils handleErrorWithJavaLangThrowable:e];
  }
...
- (ComSparsewareBellavistaTrendPanel *)createTrendPanelFromTableWithRARETableViewer:(RARETableViewer *)table
  ...
  ComSparsewareBellavistaTrendPanel *p = [[ComSparsewareBellavistaTrendPanel alloc] initWithNSString:title withNSString:title withRAREUTJSONArray:nil];
  id<JavaUtilList> rows = [((RARETableViewer *) nil_chk(table)) getRows];
  int len = [((id<JavaUtilList>) nil_chk(rows)) size];
  for (int i = 0; i < len; i++) {
    id<RAREUTiFilterableList> subs = [((RARERenderableDataItem *) nil_chk([((RARERenderableDataItem *) nil_chk([rows getWithInt:i])) getWithInt:0])) getItems];
    int nlen = [((id<RAREUTiFilterableList>) nil_chk(subs)) size];
    for (int n = 0; n < nlen; n++) {
      RARERenderableDataItem *row = [subs getWithInt:n];
      RARERenderableDataItem *name = [((RARERenderableDataItem *) nil_chk(row)) getItemExWithInt:[ComSparsewareBellavistaaResultsManager NAME_POSITION]];
      if (name == nil) {
        continue;
      }
      ...
      if ([ComSparsewareBellavistaUtils isChartableWithNSString:value]) {
        ...
        [((RAREUTMutableInteger *) nil_chk(count)) incrementAndGet];
        [p addTrendWithNSString:key withJavaUtilDate:(JavaUtilDate *) check_class_cast([((RARERenderableDataItem *) nil_chk([row getWithInt:[ComSparsewareBellavistaaResultsManager DATE_POSITION]])) getValue], [JavaUtilDate class]) withNSString:(NSString *) check_class_cast([name getValue], [NSString class]) withRARERenderableDataItem:valueItem];
      }
    }
  }
  return p;
...
- (IOSObjectArray *)createTrendPanelsWithRAREUTJSONArray:(RAREUTJSONArray *)trends {
  ...
  IOSObjectArray *a = [IOSObjectArray arrayWithLength:len type:[IOSClass classWithClass:[ComSparsewareBellavistaTrendPanel class]]];
  for (int i = 0; i < len; i++) {
    RAREUTJSONObject *o = [((RAREUTJSONArray *) nil_chk(trends)) getJSONObjectWithInt:i];
    ComSparsewareBellavistaTrendPanel *p = [[ComSparsewareBellavistaTrendPanel alloc] initWithNSString:[((RAREUTJSONObject *) nil_chk(o)) getStringWithNSString:@"name"] withNSString:[o getStringWithNSString:@"title"] withRAREUTJSONArray:[o getJSONArrayWithNSString:@"keys"]];
    (void) IOSObjectArray_Set(a, i, p);
  }
  return a;
}
...
- (void)dataParsedWithRAREiWidget:(id<RAREiWidget>)widget
  ...
  if (!isSummary_) {
    ...
    if (title != nil) {
      [table setColumnTitleWithInt:1 withNSString:title];
    }
  }
  if (trendPanels_ != nil) {
    {
      ...
      while (b__ < e__) {
        ComSparsewareBellavistaTrendPanel *p = (*b__++);
        [((ComSparsewareBellavistaTrendPanel *) nil_chk(p)) clear];
      }
    }
  }
  int len = [((id<JavaUtilList>) nil_chk(rows)) size];
  ...
  (void) [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) executeWorkerTaskWithRAREiWorkerTask:[[ComSparsewareBellavistaLabs_$3 alloc] initWithComSparsewareBellavistaLabs:self withRARETableViewer:table withJavaUtilList:rows]];
}

- (NSString *)getCategoryWithRARERenderableDataItem:(RARERenderableDataItem *)row {
  return (NSString *) check_class_cast([((RARERenderableDataItem *) nil_chk([((RARERenderableDataItem *) nil_chk(row)) getWithInt:ComSparsewareBellavistaLabs_CATEGORY_NAME_POSITION_])) getValue], [NSString class]);
}
...
- (void)handleSummaryLabsWithRARETableViewer:(RARETableViewer *)table
  ...
  for (int i = 0; i < len; i++) {
    ...
    RARERenderableDataItem *item = [((RARERenderableDataItem *) nil_chk(row)) getWithInt:[ComSparsewareBellavistaaResultsManager NAME_POSITION]];
    if (uniqueSummaryEntries_) {
      ...
      if ([map addWithId:key]) {
        [list addWithId:row];
        beg = (JavaUtilDate *) check_class_cast([((RARERenderableDataItem *) nil_chk([row getWithInt:[ComSparsewareBellavistaaResultsManager DATE_POSITION]])) getValue], [JavaUtilDate class]);
        if (end == nil) {
          end = beg;
        }
      }
  ...
  NSString *value = s;
  if (label != nil) {
    [RAREPlatform runOnUIThreadWithJavaLangRunnable:[[ComSparsewareBellavistaLabs_$4 alloc] initWithRAREiWidget:label withNSString:value]];
  }
}
...
- (void)loadStainsWithRAREWindowViewer:(RAREWindowViewer *)w
  ...
  int len = [((ComSparsewareBellavistaDocument *) nil_chk(doc)) getAttachmentCount];
  BOOL error = NO;
  for (int i = 0; i < len; i++) {
    ComSparsewareBellavistaDocument_DocumentItem *di = [doc getAttachmentWithInt:i];
    if (![@"stains" isEqual:((ComSparsewareBellavistaDocument_DocumentItem *) nil_chk(di))->customItemType_]) {
      continue;
    }
    @try {
      [((id<RAREiWidget>) nil_chk(browser)) setValueWithId:di->itemBody_];
    }
    @catch (JavaLangException *e) {
  ...
  if (error) {
    [((RAREWindowViewer *) nil_chk([RAREPlatform getWindowViewer])) alertWithId:[((RAREWindowViewer *) nil_chk([RAREPlatform getWindowViewer])) getStringWithNSString:@"bv.text.labs_susceptibilities_error"]];
  }
}
...
- (void)loadSusceptibilitiesWithRAREWindowViewer:(RAREWindowViewer *)w
  ...
  for (int i = 0; i < len; i++) {
    ComSparsewareBellavistaDocument_DocumentItem *di = [doc getAttachmentWithInt:i];
    if (![@"susceptibilities" isEqual:((ComSparsewareBellavistaDocument_DocumentItem *) nil_chk(di))->customItemType_]) {
      continue;
    }
    @try {
      RAREActionLink *link = [[RAREActionLink alloc] initWithNSString:di->itemBody_ withNSString:di->mimeType_];
      [link setContextWithRAREiWidget:table];
      ...
      [table resetTableWithJavaUtilList:tcols withJavaUtilList:[ComSparsewareBellavistaUtils groupRowsWithRARETableViewer:table withJavaUtilList:list withInt:0 withInt:0 withBoolean:NO]];
      for (int n = 2; n < len; n++) {
...
- (void)processDataWithRARETableViewer:(RARETableViewer *)table
                      withJavaUtilList:(id<JavaUtilList>)rows {
  @try {
    [ComSparsewareBellavistaUtils checkRowsInReverseAndOptimizeDatesWithJavaUtilList:rows withInt:[ComSparsewareBellavistaaResultsManager DATE_POSITION] withInt:RARERenderableDataItem_TYPE_DATETIME withComSparsewareBellavistaiValueChecker:self];
    ...
    if (isSummary_) {
      ...
      if (collectionInfoMap_ != nil && ![collectionInfoMap_ isEmpty]) {
        ...
        for (int i = 0; i < len; i++) {
          RARERenderableDataItem *row = [rows getWithInt:i];
          JavaUtilDate *date = (JavaUtilDate *) check_class_cast([((RARERenderableDataItem *) nil_chk([((RARERenderableDataItem *) nil_chk(row)) getWithInt:[ComSparsewareBellavistaaResultsManager DATE_POSITION]])) getValue], [JavaUtilDate class]);
          RARERenderableDataItem *ci = [collectionInfoMap_ getWithId:date];
          if (ci == nil) {
            continue;
          }
          RARERenderableDataItem *item = [((RARERenderableDataItem *) nil_chk(ci)) getItemExWithInt:ComSparsewareBellavistaLabs_COMMENT_POSITION_];
          NSString *s = item == nil ? @"" : [item description];
          if ([@"true" isEqual:s]) {
            item = [row getItemExWithInt:[ComSparsewareBellavistaaResultsManager NAME_POSITION]];
          ...
          [row setLinkedDataWithId:[((RARERenderableDataItem *) nil_chk([ci getItemExWithInt:[ComSparsewareBellavistaaResultsManager VALUE_POSITION]])) getValue]];
        }
...
- (BOOL)reportHasStainsWithComSparsewareBellavistaDocument:(ComSparsewareBellavistaDocument *)doc {
  ...
  for (int i = 0; i < len; i++) {
    ComSparsewareBellavistaDocument_DocumentItem *di = [doc getAttachmentWithInt:i];
    if ([@"stains" equalsIgnoreCase:((ComSparsewareBellavistaDocument_DocumentItem *) nil_chk(di))->customItemType_]) {
      return YES;
    }
  }
  return NO;
...
- (BOOL)reportHasSusceptibilitiesWithComSparsewareBellavistaDocument:(ComSparsewareBellavistaDocument *)doc {
  ...
  for (int i = 0; i < len; i++) {
    ComSparsewareBellavistaDocument_DocumentItem *di = [doc getAttachmentWithInt:i];
    if ([@"susceptibilities" equalsIgnoreCase:((ComSparsewareBellavistaDocument_DocumentItem *) nil_chk(di))->customItemType_]) {
      return YES;
    }
  }
  return NO;
...
- (void)reset {
  [super reset];
  if ([RAREUIScreen isLargeScreen]) {
    currentView_ = [ComSparsewareBellavistaResultsViewEnum TRENDS];
  }
  overViewLoaded_ = NO;
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { "getDisplayedActionPath", NULL, "LComSparsewareBellavistaActionPath", 0x1, NULL },
    ...
    { "getActionPath", NULL, "LComSparsewareBellavistaActionPath", 0x1, NULL },
    ...
    { "createTrendPanelFromTableWithRARETableViewer:withNSString:", NULL, "LComSparsewareBellavistaTrendPanel", 0x4, NULL },
    { "createTrendPanelsWithRAREUTJSONArray:", NULL, "LIOSObjectArray", 0x4, NULL },
    ...
    { "loadStainsWithRAREWindowViewer:withComSparsewareBellavistaDocument:withRAREiWidget:", NULL, "V", 0x4, NULL },
    { "loadSusceptibilitiesWithRAREWindowViewer:withComSparsewareBellavistaDocument:withRARETableViewer:", NULL, "V", 0x4, NULL },
    { "processDataWithRARETableViewer:withJavaUtilList:", NULL, "V", 0x4, NULL },
    { "reportHasStainsWithComSparsewareBellavistaDocument:", NULL, "Z", 0x4, NULL },
    { "reportHasSusceptibilitiesWithComSparsewareBellavistaDocument:", NULL, "Z", 0x4, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "bunValue_", NULL, 0x4, "LComSparsewareBellavistaClinicalValue" },
    { "creatinineValue_", NULL, 0x4, "LComSparsewareBellavistaClinicalValue" },
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaLabs = { "Labs", "com.sparseware.bellavista", NULL, 0x1, 19, methods, 26, fields, 0, NULL};
  return &_ComSparsewareBellavistaLabs;
}

@end
@implementation ComSparsewareBellavistaLabs_ChartHandler

- (id)initWithComSparsewareBellavistaLabs:(ComSparsewareBellavistaLabs *)outer$
                     withRAREUTJSONObject:(RAREUTJSONObject *)chartsInfo {
  return [super initWithNSString:@"Labs" withRAREUTJSONObject:chartsInfo withInt:[ComSparsewareBellavistaaResultsManager NAME_POSITION] withInt:[ComSparsewareBellavistaaResultsManager DATE_POSITION] withInt:[ComSparsewareBellavistaaResultsManager VALUE_POSITION]];
}

+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcClassInfo _ComSparsewareBellavistaLabs_ChartHandler = { "ChartHandler", "com.sparseware.bellavista", "Labs", 0x0, 0, NULL, 0, NULL, 0, NULL};
  return &_ComSparsewareBellavistaLabs_ChartHandler;
}

@end
@implementation ComSparsewareBellavistaLabs_$1
...
withRAREUTiStringConverter:(id<RAREUTiStringConverter>)converter {
  ...
  if (this$0_->currentView_ == [ComSparsewareBellavistaResultsViewEnum SPREADSHEET]) {
    return [((NSString *) nil_chk(val$cat_)) isEqual:[((RARERenderableDataItem *) nil_chk(item)) getLinkedData]];
  }
  else {
    item = [((RARERenderableDataItem *) nil_chk(item)) getItemExWithInt:[ComSparsewareBellavistaLabs CATEGORY_NAME_POSITION]];
    return (item == nil) ? NO : [item valueEqualsWithId:val$cat_];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LComSparsewareBellavistaLabs" },
    { "val$cat_", NULL, 0x1012, "LNSString" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaLabs_$1 = { "$1", "com.sparseware.bellavista", "Labs", 0x8000, 1, methods, 2, fields, 0, NULL};
  return &_ComSparsewareBellavistaLabs_$1;
}

@end
@implementation ComSparsewareBellavistaLabs_$2
...
- (void)finishedWithBoolean:(BOOL)canceled
  ...
  if (w != nil) {
    [w setValueWithId:[((RARERenderableDataItem *) nil_chk([((RARERenderableDataItem *) nil_chk(val$row_)) getWithInt:[ComSparsewareBellavistaaResultsManager NAME_POSITION]])) getValue]];
  }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaLabs_$2 = { "$2", "com.sparseware.bellavista", "Labs", 0x8000, 0, NULL, 4, fields, 0, NULL};
  return &_ComSparsewareBellavistaLabs_$2;
}

@end
@implementation ComSparsewareBellavistaLabs_$3
...
- (void)finishWithId:(id)result {
  ...
  if ([result isKindOfClass:[JavaLangThrowable class]]) {
    [ComSparsewareBellavistaUtils handleErrorWithJavaLangThrowable:(JavaLangThrowable *) check_class_cast(result, [JavaLangThrowable class])];
  }
  else {
    if (this$0_->overViewLoaded_ && this$0_->trendPanels_ != nil) {
      ...
      RARETableViewer *ttable = (RARETableViewer *) check_class_cast([((id<RAREiContainer>) nil_chk(c)) getWidgetWithNSString:@"trendsTable"], [RARETableViewer class]);
      {
        ...
        while (b__ < e__) {
          ComSparsewareBellavistaTrendPanel *p = (*b__++);
          [((ComSparsewareBellavistaTrendPanel *) nil_chk(p)) popuplateTableWithRARETableViewer:ttable withJavaUtilMap:this$0_->trendsLayout_];
        }
      }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaLabs_$3 = { "$3", "com.sparseware.bellavista", "Labs", 0x8000, 1, methods, 3, fields, 0, NULL};
  return &_ComSparsewareBellavistaLabs_$3;
}

@end
@implementation ComSparsewareBellavistaLabs_$4

- (void)run {
  if (![((id<RAREiWidget>) nil_chk(val$label_)) isDisposed]) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaLabs_$4 = { "$4", "com.sparseware.bellavista", "Labs", 0x8000, 0, NULL, 2, fields, 0, NULL};
  return &_ComSparsewareBellavistaLabs_$4;
}

...
- (CCPBVTrendPanel *)createTrendPanelFromTableWithRARETableViewer:(RARETableViewer *)table
  ...
  CCPBVTrendPanel *p = [[CCPBVTrendPanel alloc] initWithNSString:title withNSString:title withRAREUTJSONArray:nil withBoolean:YES];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVLabs = { "Labs", "com.sparseware.bellavista", NULL, 0x1, 18, methods, 26, fields, 0, NULL};
  return &_CCPBVLabs;
}

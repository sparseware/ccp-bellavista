...
- (id)init {
  if (self = [super initWithNSString:@"vitals" withNSString:@"Vitals"]) {
    reuseableSB_ = [[JavaLangStringBuilder alloc] init];
  ...
  @try {
    do {
      ...
      if (showUnits_) {
        ...
        NSString *unit = (unitItem == nil) ? @"" : [unitItem description];
        if ([unit sequenceLength] > 0) {
          JavaLangStringBuilder *sb = reuseableSB_;
...
- (void)onFinishedLoadingWithNSString:(NSString *)eventName
  ...
  if ([CCPBVUtils isCardStack] && (trendPanels_ != nil) && ((int) [trendPanels_ count] > 0)) {
    id<RAREiContainer> fv = (id<RAREiContainer>) check_protocol_cast([((id<RAREiFormViewer>) nil_chk([widget getFormViewer])) getWidgetWithNSString:@"trends"], @protocol(RAREiContainer));
...
- (id<JavaUtilList>)createSpreadsheetRowsWithRAREaWidget:(RAREaWidget *)context {
  ...
  for (int i = 0; i < len; i++) {
    ...
    row = [map getWithId:s];
    if (row == nil) {
      row = [((RAREaWidget *) nil_chk(context)) createRowWithInt:clen + 1 withBoolean:NO];
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    row = [((RAREaWidget *) nil_chk(context)) createRowWithInt:clen + 3 withBoolean:NO];
...
- (void)copyAllFieldsTo:(CCPBVVitals *)other {
  ...
  other->reuseableSB_ = reuseableSB_;
  other->showUnits_ = showUnits_;
  other->trendPanels_ = trendPanels_;
  other->updateWeightHeight_ = updateWeightHeight_;
}

+ (IOSObjectArray *)__annotations_selectVitalsWithNSString_withRAREiWidget_withJavaUtilEventObject_ {
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "createSpreadsheetRowsWithRAREaWidget:", NULL, "LJavaUtilList", 0x4, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    { "checkedForMonitoringSupport_", NULL, 0xc, "Z" },
    { "monitoringClass_", NULL, 0xc, "LIOSClass" },
    { "monitorInstance_", NULL, 0xc, "LCCPBVaRemoteMonitor" },
    { "showUnits_", NULL, 0x4, "Z" },
    { "updateWeightHeight_", NULL, 0x4, "Z" },
    { "trendPanels_", NULL, 0x4, "LIOSObjectArray" },
  };
  static J2ObjcClassInfo _CCPBVVitals = { "Vitals", "com.sparseware.bellavista", NULL, 0x1, 8, methods, 6, fields, 0, NULL};
  return &_CCPBVVitals;
}

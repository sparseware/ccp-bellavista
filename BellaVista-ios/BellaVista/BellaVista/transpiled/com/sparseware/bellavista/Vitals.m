...
static BOOL CCPBVVitals_checkForMonitoringSupport_;
...
+ (BOOL)checkForMonitoringSupport {
  return CCPBVVitals_checkForMonitoringSupport_;
}
...
- (id)init {
  if (self = [super initWithNSString:@"vitals" withNSString:@"Vitals"]) {
    ...
    if (!CCPBVVitals_checkForMonitoringSupport_) {
...
- (void)showComboChartWithRAREStackPaneViewer:(RAREStackPaneViewer *)sp {
  ...
  @try {
    if (sp == nil) {
      ...
      CCPBVSummaryVitalsHandler *parser = [[CCPBVSummaryVitalsHandler alloc] init];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "checkForMonitoringSupport_", NULL, 0x8, "Z" },
    { "monitoringClass_", NULL, 0x8, "LIOSClass" },
    { "monitorInstance_", NULL, 0x8, "LCCPBVaRemoteMonitor" },
  };
  static J2ObjcClassInfo _CCPBVVitals = { "Vitals", "com.sparseware.bellavista", NULL, 0x1, 8, methods, 3, fields, 0, NULL};
  return &_CCPBVVitals;
}

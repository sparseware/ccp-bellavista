...
@implementation ComSparsewareBellavistaActions
...
- (void)onExitWithNSString:(NSString *)eventName
           withRAREiWidget:(id<RAREiWidget>)widget
   withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [ComSparsewareBellavistaUtils exit];
}

- (void)onPreferencesWithNSString:(NSString *)eventName
                  withRAREiWidget:(id<RAREiWidget>)widget
          withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [ComSparsewareBellavistaUtils showDialogWithNSString:@"/settings.rml" withBoolean:NO withBoolean:NO];
}

- (void)onLockWithNSString:(NSString *)eventName
           withRAREiWidget:(id<RAREiWidget>)widget
   withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [ComSparsewareBellavistaUtils lockApplicationWithBoolean:NO];
}

- (void)onChangePatientWithNSString:(NSString *)eventName
                    withRAREiWidget:(id<RAREiWidget>)widget
            withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [ComSparsewareBellavistaPatientSelect changePatientWithRAREiWidget:widget withComSparsewareBellavistaActionPath:nil];
}
...
- (void)onFlagsWithNSString:(NSString *)eventName
  ...
  @try {
    if ([RAREUIScreen isLargeScreen]) {
      ...
      [ComSparsewareBellavistaUtils pushWorkspaceViewerWithNSString:@"/flags.rml"];
    }
  }
...
- (void)onFullscreenWithNSString:(NSString *)eventName
  ...
  if (![RAREUIScreen isLargeScreen]) {
    [ComSparsewareBellavistaUtils popWorkspaceViewer];
  }
  else {
    RARESplitPaneViewer *sp = [ComSparsewareBellavistaUtils getSplitPaneViewerWithRAREiWidget:widget];
    if (sp == nil) {
      return;
    }
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcClassInfo _ComSparsewareBellavistaActions = { "Actions", "com.sparseware.bellavista", NULL, 0x1, 0, NULL, 0, NULL, 0, NULL};
  return &_ComSparsewareBellavistaActions;
}

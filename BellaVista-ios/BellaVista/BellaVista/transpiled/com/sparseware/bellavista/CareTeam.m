...
@implementation ComSparsewareBellavistaCareTeam

static ComSparsewareBellavistaExternalaCommunicationHandler_UserStatus * ComSparsewareBellavistaCareTeam_OFFLINE_;

+ (ComSparsewareBellavistaExternalaCommunicationHandler_UserStatus *)OFFLINE {
  return ComSparsewareBellavistaCareTeam_OFFLINE_;
}

+ (void)setOFFLINE:(ComSparsewareBellavistaExternalaCommunicationHandler_UserStatus *)OFFLINE {
  ComSparsewareBellavistaCareTeam_OFFLINE_ = OFFLINE;
}
...
- (id)init {
  if (self = [super init]) {
    ...
    commHandler_ = [ComSparsewareBellavistaUtils getaCommunicationHandler];
    if (commHandler_ != nil) {
      userStatuses_ = [[JavaUtilHashMap alloc] init];
      statusIcons_ = [ComSparsewareBellavistaUtils getStatusIcons];
...
- (void)onDisposeWithNSString:(NSString *)eventName
  ...
  if (commHandler_ != nil) {
    [commHandler_ removeStatusListenerWithComSparsewareBellavistaExternalaCommunicationHandler_iStatusListener:self];
  }
  commHandler_ = nil;
  userStatuses_ = nil;
  listViewer_ = nil;
...
- (void)onShownWithNSString:(NSString *)eventName
  ...
  if (lastUpdateTime_ + dataTimeout_ > [JavaLangSystem currentTimeMillis] && [((id<RAREiDataCollection>) nil_chk(dc)) isLoaded]) {
    ...
    RAREaWorkerTask *task = [[ComSparsewareBellavistaCareTeam_$1 alloc] initWithComSparsewareBellavistaCareTeam:self withRAREWindowViewer:w withRAREiWidget:widget withRAREiDataCollection:dc];
    [w showWaitCursor];
...
- (void)updateFormWithRAREiFormViewer:(id<RAREiFormViewer>)fv
  ...
  if (![users isEmpty]) {
    [((ComSparsewareBellavistaExternalaCommunicationHandler *) nil_chk(commHandler_)) addStatusListenerWithJavaUtilList:users withComSparsewareBellavistaExternalaCommunicationHandler_iStatusListener:self];
  }
}
...
- (void)onListChangeWithNSString:(NSString *)eventName
  ...
  if (commHandler_ != nil) {
    ...
    ComSparsewareBellavistaExternalaCommunicationHandler_UserStatus *status = id_ == nil ? ComSparsewareBellavistaCareTeam_OFFLINE_ : [((id<JavaUtilMap>) nil_chk(userStatuses_)) getWithId:id_];
    if (status == nil) {
      status = ComSparsewareBellavistaCareTeam_OFFLINE_;
    }
    ...
    if (pb != nil) {
      [pb setEnabledWithBoolean:[commHandler_ isVideoChatAvailable] && ((ComSparsewareBellavistaExternalaCommunicationHandler_UserStatus *) nil_chk(status))->videoChat_ != [ComSparsewareBellavistaExternalaCommunicationHandler_StatusEnum ONLINE]];
    }
    pb = (RAREPushButtonWidget *) check_class_cast([fv getWidgetWithNSString:@"bv.action.audio_chat"], [RAREPushButtonWidget class]);
    if (pb != nil) {
      [pb setEnabledWithBoolean:[commHandler_ isVideoChatAvailable] && ((ComSparsewareBellavistaExternalaCommunicationHandler_UserStatus *) nil_chk(status))->audioChat_ != [ComSparsewareBellavistaExternalaCommunicationHandler_StatusEnum ONLINE]];
    }
    pb = (RAREPushButtonWidget *) check_class_cast([fv getWidgetWithNSString:@"bv.action.text_chat"], [RAREPushButtonWidget class]);
    if (pb != nil) {
      [pb setEnabledWithBoolean:[commHandler_ isVideoChatAvailable] && ((ComSparsewareBellavistaExternalaCommunicationHandler_UserStatus *) nil_chk(status))->textChat_ != [ComSparsewareBellavistaExternalaCommunicationHandler_StatusEnum ONLINE]];
    }
  }
}
...
+ (void)initialize {
  if (self == [ComSparsewareBellavistaCareTeam class]) {
    ComSparsewareBellavistaCareTeam_OFFLINE_ = [[ComSparsewareBellavistaExternalaCommunicationHandler_UserStatus alloc] init];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "commHandler_", NULL, 0x4, "LComSparsewareBellavistaExternalaCommunicationHandler" },
    { "userStatuses_", NULL, 0x4, "LJavaUtilMap" },
    { "listViewer_", NULL, 0x4, "LRAREListBoxViewer" },
    { "OFFLINE_", NULL, 0xc, "LComSparsewareBellavistaExternalaCommunicationHandler_UserStatus" },
    { "statusIcons_", NULL, 0x4, "LJavaUtilMap" },
    { "idPosition_", NULL, 0x4, "I" },
    { "lastUpdateTime_", NULL, 0x4, "J" },
    { "dataTimeout_", NULL, 0x4, "I" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaCareTeam = { "CareTeam", "com.sparseware.bellavista", NULL, 0x1, 2, methods, 8, fields, 0, NULL};
  return &_ComSparsewareBellavistaCareTeam;
}

@end
@implementation ComSparsewareBellavistaCareTeam_$1
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LComSparsewareBellavistaCareTeam" },
    { "val$w_", NULL, 0x1012, "LRAREWindowViewer" },
    { "val$widget_", NULL, 0x1012, "LRAREiWidget" },
    { "val$dc_", NULL, 0x1012, "LRAREiDataCollection" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaCareTeam_$1 = { "$1", "com.sparseware.bellavista", "CareTeam", 0x8000, 1, methods, 4, fields, 0, NULL};
  return &_ComSparsewareBellavistaCareTeam_$1;
}

...
- (void)processDataWithRARETableViewer:(RARETableViewer *)table
  ...
  @try {
    ...
    dataLoaded_ = YES;
    [RAREPlatform invokeLaterWithJavaLangRunnable:[[CCPBVOrders_$2 alloc] initWithCCPBVOrders:self withRARETableViewer:table withJavaUtilList:categories withInt:selectedIndex withCCPBVActionPath:path]];
  }
  @catch (JavaLangException *e) {
    [CCPBVUtils handleErrorWithJavaLangThrowable:e];
  }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVOrders = { "Orders", "com.sparseware.bellavista", NULL, 0x1, 7, methods, 23, fields, 0, NULL};
  return &_CCPBVOrders;
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVOrders_$2 = { "$2", "com.sparseware.bellavista", "Orders", 0x8000, 0, NULL, 5, fields, 0, NULL};

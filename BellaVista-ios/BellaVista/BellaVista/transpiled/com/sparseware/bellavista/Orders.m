...
@implementation ComSparsewareBellavistaOrders

static int ComSparsewareBellavistaOrders_SIG_COLUMN_ = 10;
static int ComSparsewareBellavistaOrders_STATUS_COLUMN_ = 8;
static int ComSparsewareBellavistaOrders_SUMMARY_STATUS_COLUMN_ = 1;

+ (int)CATEGORY_NAME_POSITION {
  return ComSparsewareBellavistaOrders_CATEGORY_NAME_POSITION;
}

+ (int)CLINICAL_CATEGORY_POSITION {
  return ComSparsewareBellavistaOrders_CLINICAL_CATEGORY_POSITION;
}

+ (int)SIG_COLUMN {
  return ComSparsewareBellavistaOrders_SIG_COLUMN_;
}
...
+ (int)STATUS_COLUMN {
  return ComSparsewareBellavistaOrders_STATUS_COLUMN_;
}
...
+ (int)SUMMARY_STATUS_COLUMN {
  return ComSparsewareBellavistaOrders_SUMMARY_STATUS_COLUMN_;
}
...
- (id)init {
  if (self = [super initWithNSString:@"orders" withNSString:@"Orders"]) {
    ...
    hasClinicalCategories_ = [((RAREUTJSONObject *) nil_chk(info)) optBooleanWithNSString:@"hasClinicalCategories" withBoolean:NO];
    includeIVsInCategorizedMeds_ = [info optBooleanWithNSString:@"includeIVsInCategorizedMeds" withBoolean:YES];
...
- (void)onSummaryTableActionWithNSString:(NSString *)eventName
  ...
  ComSparsewareBellavistaActionPath *path = [[ComSparsewareBellavistaActionPath alloc] initWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"orders", key } count:2 type:[IOSClass classWithClass:[NSString class]]]];
...
- (void)dataParsedWithRAREiWidget:(id<RAREiWidget>)widget
  ...
  (void) [((id<RAREiPlatformAppContext>) nil_chk([RAREPlatform getAppContext])) executeBackgroundTaskWithJavaLangRunnable:[[ComSparsewareBellavistaOrders_$1 alloc] initWithComSparsewareBellavistaOrders:self withRARETableViewer:table withJavaUtilList:rows]];
}
...
- (void)processDataWithRARETableViewer:(RARETableViewer *)table
  ...
  @try {
    ...
    for (int i = 0; i < len; i++) {
      ...
      statusColor = nil;
      statusColorC = nil;
      if (([((RARERenderableDataItem *) nil_chk(row)) size] > ComSparsewareBellavistaOrders_STATUS_COLUMN_)) {
        s = [((RARERenderableDataItem *) nil_chk([row getWithInt:ComSparsewareBellavistaOrders_STATUS_COLUMN_])) description];
      ...
      if (((sig == nil) || ([sig sequenceLength] == 0)) && ([row size] > ComSparsewareBellavistaOrders_SIG_COLUMN_)) {
        sig = (NSString *) check_class_cast([((RARERenderableDataItem *) nil_chk([row getWithInt:ComSparsewareBellavistaOrders_SIG_COLUMN_])) getValue], [NSString class]);
      ...
      if (hasCC) {
        RARERenderableDataItem *cc = [row getWithInt:ComSparsewareBellavistaOrders_CLINICAL_CATEGORY_POSITION];
      ...
      s = [((RARERenderableDataItem *) nil_chk([row getWithInt:ComSparsewareBellavistaOrders_CATEGORY_NAME_POSITION])) description];
      if ([((NSString *) nil_chk(s)) sequenceLength] == 0) {
        s = missingCategoryTitle_;
        [((RARERenderableDataItem *) nil_chk([row getWithInt:ComSparsewareBellavistaOrders_CATEGORY_NAME_POSITION])) setValueWithId:s];
      }
    ...
    allOrders_ = rows = [ComSparsewareBellavistaUtils groupRowsWithRARETableViewer:table withJavaUtilList:rows withInt:ComSparsewareBellavistaOrders_CATEGORY_NAME_POSITION withInt:-1 withBoolean:NO];
    if (hasClinicalCategories_) {
      ...
      if (meds != nil) {
        categorizedMeds_ = [ComSparsewareBellavistaUtils groupRowsWithRARETableViewer:table withJavaUtilList:[meds getItems] withInt:ComSparsewareBellavistaOrders_CLINICAL_CATEGORY_POSITION withInt:-1 withBoolean:NO];
    ...
    dataLoaded_ = YES;
    [RAREPlatform invokeLaterWithJavaLangRunnable:[[ComSparsewareBellavistaOrders_$2 alloc] initWithComSparsewareBellavistaOrders:self withRARETableViewer:table withJavaUtilList:categories withInt:selectedIndex withComSparsewareBellavistaActionPath:path]];
  }
  @catch (JavaLangException *e) {
    [ComSparsewareBellavistaUtils handleErrorWithJavaLangThrowable:e];
  }
...
- (void)updateCategoriesWithRAREiFormViewer:(id<RAREiFormViewer>)fv
  ...
  if (categories == nil || [categories isEmpty]) {
    [((RAREaWidget *) nil_chk(cw)) setEnabledWithBoolean:NO];
    [cw setValueWithId:nil];
  }
  else if ([cw isKindOfClass:[RAREaWidget class]]) {
    [((RAREaWidget *) nil_chk(cw)) setEnabledWithBoolean:YES];
    if (selectedIndex == -1) {
      selectedIndex = 0;
    }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaOrders = { "Orders", "com.sparseware.bellavista", NULL, 0x1, 7, methods, 23, fields, 0, NULL};
  return &_ComSparsewareBellavistaOrders;
}

@end
@implementation ComSparsewareBellavistaOrders_$1
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LComSparsewareBellavistaOrders" },
    { "val$table_", NULL, 0x1012, "LRARETableViewer" },
    { "val$rows_", NULL, 0x1012, "LJavaUtilList" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaOrders_$1 = { "$1", "com.sparseware.bellavista", "Orders", 0x8000, 0, NULL, 3, fields, 0, NULL};
  return &_ComSparsewareBellavistaOrders_$1;
}

@end
@implementation ComSparsewareBellavistaOrders_$2
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaOrders_$2 = { "$2", "com.sparseware.bellavista", "Orders", 0x8000, 0, NULL, 5, fields, 0, NULL};
  return &_ComSparsewareBellavistaOrders_$2;
}

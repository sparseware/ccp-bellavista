...
J2OBJC_FIELD_SETTER(CCPBVMainEventHandler_$3, val$v_, id<RAREiViewer>)

@interface CCPBVMainEventHandler_$4 : NSObject < RAREiFunctionCallback > {
 @public
...
J2OBJC_FIELD_SETTER(CCPBVMainEventHandler_$4, val$ip_, RAREImagePaneViewer *)

...
#ifndef _ComSparsewareBellavistaMainEventHandler_H_
#define _ComSparsewareBellavistaMainEventHandler_H_
...
@interface ComSparsewareBellavistaMainEventHandler : NSObject < RAREiEventHandler > {
 @public
...
J2OBJC_FIELD_SETTER(ComSparsewareBellavistaMainEventHandler, lineBorder_, RAREUILineBorder *)

@interface ComSparsewareBellavistaMainEventHandler_$1 : NSObject < JavaLangRunnable > {
 @public
...
J2OBJC_FIELD_SETTER(ComSparsewareBellavistaMainEventHandler_$1, val$lv_, RAREaListViewer *)

@interface ComSparsewareBellavistaMainEventHandler_$2 : NSObject < RAREiFunctionCallback > {
 @public
...
J2OBJC_FIELD_SETTER(ComSparsewareBellavistaMainEventHandler_$2, val$sp_, RAREStackPaneViewer *)

@interface ComSparsewareBellavistaMainEventHandler_$3 : NSObject < RAREiFunctionCallback > {
 @public
...
J2OBJC_FIELD_SETTER(ComSparsewareBellavistaMainEventHandler_$3, val$ip_, RAREImagePaneViewer *)

#endif // _ComSparsewareBellavistaMainEventHandler_H_

...
@implementation ComSparsewareBellavistaaEventHandler
...
- (void)parseDataURLWithRAREaWidget:(RAREaWidget *)widget
  ...
  RAREActionLink *link = [ComSparsewareBellavistaUtils createLinkWithRAREiWidget:widget withNSString:href withBoolean:rowInfo];
...
- (void)parseDataURLWithRAREaWidget:(RAREaWidget *)widget
  ...
  id<RAREiWorkerTask> task = [[ComSparsewareBellavistaaEventHandler_$1 alloc] initWithComSparsewareBellavistaaEventHandler:self withRAREWindowViewer:w withRAREaWidget:widget withRAREActionLink:link withBoolean:tabular];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaaEventHandler = { "aEventHandler", "com.sparseware.bellavista", NULL, 0x401, 4, methods, 0, NULL, 0, NULL};
  return &_ComSparsewareBellavistaaEventHandler;
}

@end
@implementation ComSparsewareBellavistaaEventHandler_$1
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LComSparsewareBellavistaaEventHandler" },
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaaEventHandler_$1 = { "$1", "com.sparseware.bellavista", "aEventHandler", 0x8000, 1, methods, 5, fields, 0, NULL};
  return &_ComSparsewareBellavistaaEventHandler_$1;
}

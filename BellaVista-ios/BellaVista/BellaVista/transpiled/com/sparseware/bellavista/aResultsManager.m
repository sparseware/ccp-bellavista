...
- (void)changePageWithBoolean:(BOOL)next
  ...
  if (link == nil) {
    ...
    [self parseDataURLWithRAREaWidget:dataTable_ withRAREActionLink:link withBoolean:YES];
  }
}
...
- (BOOL)checkAndHandleNoDataWithRARETableViewer:(RARETableViewer *)table
  ...
  if ((len == 0) || ((len == 1) && ![((RARERenderableDataItem *) nil_chk([((id<JavaUtilList>) nil_chk(rows)) getWithInt:0])) isEnabled])) {
    ...
    if (len == 1) {
      ...
      [((RARETableViewer *) nil_chk(table)) addParsedRowWithRARERenderableDataItem:[self createNoDataRowWithRARETableViewer:table withNSString:nil]];
    }
...
- (void)onFirstPageWithNSString:(NSString *)eventName
                withRAREiWidget:(id<RAREiWidget>)widget
        withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [self changeSpreadsheetPageWithRAREiWidget:widget withBoolean:NO withBoolean:YES];
}

- (void)onLastPageWithNSString:(NSString *)eventName
               withRAREiWidget:(id<RAREiWidget>)widget
       withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [self changeSpreadsheetPageWithRAREiWidget:widget withBoolean:YES withBoolean:YES];
}

- (void)onNextPageWithNSString:(NSString *)eventName
               withRAREiWidget:(id<RAREiWidget>)widget
       withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [self changeSpreadsheetPageWithRAREiWidget:widget withBoolean:YES withBoolean:NO];
}

- (void)onPreviousPageWithNSString:(NSString *)eventName
                   withRAREiWidget:(id<RAREiWidget>)widget
           withJavaUtilEventObject:(JavaUtilEventObject *)event {
  [self changeSpreadsheetPageWithRAREiWidget:widget withBoolean:NO withBoolean:NO];
}
...
- (void)onTableCreatedWithNSString:(NSString *)eventName
  ...
  RAREActionLink *link = [[RAREActionLink alloc] initWithRAREUTiURLResolver:widget withSPOTPrintableString:((RARESPOTTable *) nil_chk(cfg))->dataURL_];
  [link setRowInfoSeparatorWithChar:[CCPBVUtils riSeparator]];
  ...
  id<RAREiFormViewer> fv = [((RARETableViewer *) nil_chk(dataTable_)) getFormViewer];
  [((id<RAREiFormViewer>) nil_chk(fv)) setAttributeWithNSString:@"data_paging_support" withId:self];
...
- (void)tableDataLoadedWithRAREActionLink:(RAREActionLink *)link {
  if (dataTable_ != nil) {
    if (dataLink_ != nil) {
      [dataTable_ setWidgetDataLinkWithRAREActionLink:dataLink_];
    }
    id<RAREiFormViewer> fv = [dataTable_ getFormViewer];
    id<RAREiWidget> buttonPanel = [((id<RAREiFormViewer>) nil_chk(fv)) getWidgetWithNSString:@"_nextPreviousPanel"];
    if (buttonPanel != nil) {
      NSString *pn = nil;
      [((CCPBVListPager *) nil_chk(pager_)) addWithRAREActionLink:link];
      pn = [((RAREActionLink *) nil_chk(link)) getPagingNext];
      if (pn != nil) {
        [buttonPanel setVisibleWithBoolean:YES];
        [pager_ setNextWithRAREActionLink:[CCPBVListPager createPagingLinkWithRAREActionLink:link withNSString:pn]];
      }
      if ([buttonPanel isVisible]) {
        RAREaGroupableButton *pb = (RAREaGroupableButton *) check_class_cast([fv getWidgetWithNSString:@"_nextPage"], [RAREaGroupableButton class]);
        if (pb != nil) {
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "changeSpreadsheetPageWithRAREiWidget:withBoolean:withBoolean:", NULL, "V", 0x4, NULL },
    ...
    { "createNoDataRowWithRARETableViewer:withNSString:", NULL, "LRARERenderableDataItem", 0x4, NULL },
    ...
    { "tableDataLoadedWithRAREActionLink:", NULL, "V", 0x4, NULL },
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "pager_", NULL, 0x4, "LCCPBVListPager" },
  };
  static J2ObjcClassInfo _CCPBVaResultsManager = { "aResultsManager", "com.sparseware.bellavista", NULL, 0x401, 39, methods, 31, fields, 0, NULL};
...
- (BOOL)checkWithNSString:(NSString *)key
  ...
  if (![((JavaUtilHashSet *) nil_chk(chartableSet_)) containsWithId:key]) {
    ...
    if ([JavaLangCharacter isDigitWithChar:c] || (c == '.')) {

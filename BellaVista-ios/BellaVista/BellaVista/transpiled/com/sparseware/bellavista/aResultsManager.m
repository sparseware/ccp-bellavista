...
- (RARERenderableDataItem *)createNoDataRowWithRARETableViewer:(RARETableViewer *)table {
  ...
  [item setValueWithId:[RAREPlatform getResourceAsStringWithNSString:[NSString stringWithFormat:@"bv.text.no_%@", namePrefix_]]];
  return row;
}
...
- (void)reselectDefaultViewWithNSString:(NSString *)eventName
                        withRAREiWidget:(id<RAREiWidget>)widget
                withJavaUtilEventObject:(JavaUtilEventObject *)event {
  RAREToolBarViewer *tb = (RAREToolBarViewer *) check_class_cast([((id<RAREiContainer>) nil_chk([((RARETableViewer *) nil_chk(dataTable_)) getParent])) getWidgetWithNSString:@"tableToolbar"], [RAREToolBarViewer class]);
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVaResultsManager = { "aResultsManager", "com.sparseware.bellavista", NULL, 0x401, 37, methods, 28, fields, 0, NULL};
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVaResultsManager_ChartableItemsManager = { "ChartableItemsManager", "com.sparseware.bellavista", "aResultsManager", 0x8, 4, methods, 2, fields, 0, NULL};

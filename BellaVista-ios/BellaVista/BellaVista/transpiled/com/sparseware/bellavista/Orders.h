...
#define CCPBVOrders_CATEGORY_NAME_POSITION 11
#define CCPBVOrders_CLINICAL_CATEGORY_POSITION 12
...
J2OBJC_FIELD_SETTER(CCPBVOrders, medicationsTitle_, NSString *)
J2OBJC_FIELD_SETTER(CCPBVOrders, ivsTitle_, NSString *)
...
@interface CCPBVOrders_$1 : RAREaWorkerTask {
 @public
  CCPBVOrders *this$0_;
  RARETableViewer *val$table_;
  RARERenderableDataItem *val$item_;
  NSString *val$cat_;
  id<RAREiWidget> val$cw_;
...
J2OBJC_FIELD_SETTER(CCPBVOrders_$1, val$item_, RARERenderableDataItem *)
J2OBJC_FIELD_SETTER(CCPBVOrders_$1, val$cat_, NSString *)
J2OBJC_FIELD_SETTER(CCPBVOrders_$1, val$cw_, id<RAREiWidget>)
J2OBJC_FIELD_SETTER(CCPBVOrders_$1, val$w_, RAREWindowViewer *)
J2OBJC_FIELD_SETTER(CCPBVOrders_$1, val$link_, RAREActionLink *)

@interface CCPBVOrders_$2 : RAREaWorkerTask {
 @public
  CCPBVOrders *this$0_;
  RAREWindowViewer *val$w_;
  RARETableViewer *val$table_;
...
J2OBJC_FIELD_SETTER(CCPBVOrders_$2, val$w_, RAREWindowViewer *)
J2OBJC_FIELD_SETTER(CCPBVOrders_$2, val$table_, RARETableViewer *)
J2OBJC_FIELD_SETTER(CCPBVOrders_$2, val$rows_, id<JavaUtilList>)
...
@interface CCPBVOrders_$4 : NSObject < JavaLangRunnable > {
 @public
  CCPBVOrders *this$0_;
  RARETableViewer *val$table_;
...
J2OBJC_FIELD_SETTER(CCPBVOrders_$4, this$0_, CCPBVOrders *)
J2OBJC_FIELD_SETTER(CCPBVOrders_$4, val$table_, RARETableViewer *)
J2OBJC_FIELD_SETTER(CCPBVOrders_$4, val$categories_, id<JavaUtilList>)
J2OBJC_FIELD_SETTER(CCPBVOrders_$4, val$path_, CCPBVActionPath *)

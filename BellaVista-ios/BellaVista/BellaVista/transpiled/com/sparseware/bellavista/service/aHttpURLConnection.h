...
@interface CCPBVaHttpURLConnection : JavaNetHttpURLConnection < CCPBViHttpConnection > {
 @public
  ...
  JavaNetHttpURLConnection *connectionPipe_;
...
J2OBJC_FIELD_SETTER(CCPBVaHttpURLConnection, connectionPipe_, JavaNetHttpURLConnection *)
J2OBJC_FIELD_SETTER(CCPBVaHttpURLConnection, defaultCharset_, NSString *)

...
- (NSString *)getHeaderFieldWithInt:(int)n {
  ...
  return [((CCPBVHttpHeaders *) nil_chk(headers_)) getHeaderWithInt:n];
}
...
- (NSString *)getHeaderFieldWithNSString:(NSString *)name {
  ...
  return [((CCPBVHttpHeaders *) nil_chk(headers_)) getHeaderWithNSString:name];
}
...
- (NSString *)getHeaderFieldKeyWithInt:(int)n {
  ...
  return [((CCPBVHttpHeaders *) nil_chk(headers_)) getKeyWithInt:n];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVaHttpURLConnection = { "aHttpURLConnection", "com.sparseware.bellavista.service", NULL, 0x401, 14, methods, 13, fields, 0, NULL};

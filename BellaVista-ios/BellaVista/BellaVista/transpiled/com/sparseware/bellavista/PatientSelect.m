...
- (id)init {
  if (self = [super init]) {
    ...
    alwaysShowSearchFirst_ = [info optBooleanWithNSString:@"alwaysShowSearchFirst" withBoolean:NO];
...
- (void)patientsTableUpdatedWithRARETableViewer:(RARETableViewer *)table
  ...
  if ([CCPBVUtils isCardStack]) {
    ...
    if ([((RAREActionLink *) nil_chk(link)) getAttributes] != nil) {
      pn = [link getLinkInfo];
      if (pn != nil) {
        [((CCPBVListPager *) nil_chk(pager_)) addWithRAREActionLink:[CCPBVListPager createPagingLinkWithRAREActionLink:link withNSString:pn]];
      }
      else {
      ...
      if (pn != nil) {
        [((CCPBVListPager *) nil_chk(pager_)) setNextWithRAREActionLink:[CCPBVListPager createPagingLinkWithRAREActionLink:link withNSString:pn]];
      }
    }
    else {
      [((CCPBVListPager *) nil_chk(pager_)) clear];
    ...
    if (pb != nil) {
      [pb setEnabledWithBoolean:[((CCPBVListPager *) nil_chk(pager_)) hasNext]];
    }
    pb = (RAREaGroupableButton *) check_class_cast([fv getWidgetWithNSString:@"previousPage"], [RAREaGroupableButton class]);
    if (pb != nil) {
      [pb setEnabledWithBoolean:[((CCPBVListPager *) nil_chk(pager_)) hasPrevious]];
    }
  }
}
...
+ (void)processPatientDataWithRAREUTJSONObject:(RAREUTJSONObject *)patient {
  ...
  NSString *s = (NSString *) check_class_cast([patient optWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"location", @"value" } count:2 type:[IOSClass classWithClass:[NSString class]]]], [NSString class]);
  (void) [app putDataWithId:@"pt_location" withId:s == nil ? [((RAREWindowViewer *) nil_chk(w)) getStringWithNSString:@"bv.text.unknownLocation"] : s];
  ...
  NSString *provider = (NSString *) check_class_cast([patient optWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"provider", @"value" } count:2 type:[IOSClass classWithClass:[NSString class]]]], [NSString class]);
  s = (NSString *) check_class_cast([patient optWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"attending", @"value" } count:2 type:[IOSClass classWithClass:[NSString class]]]], [NSString class]);
  ...
  obj = [patient optWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"location", @"value" } count:2 type:[IOSClass classWithClass:[NSString class]]]];
  if (obj == nil) {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVPatientSelect = { "PatientSelect", "com.sparseware.bellavista", NULL, 0x1, 18, methods, 34, fields, 0, NULL};

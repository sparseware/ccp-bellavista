...
+ (id<RAREiPlatformIcon>)getThimbnailWithRAREWindowViewer:(RAREWindowViewer *)w
  ...
  if (link != nil) {
    ...
    @try {
      icon = [((RAREWindowViewer *) nil_chk(w)) getIconWithJavaNetURL:[link getURLWithRAREUTiURLResolver:w] withNSString:s withFloat:1];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVPatientSelect_PatientIcon = { "PatientIcon", "com.sparseware.bellavista", "PatientSelect", 0x8, 2, methods, 3, fields, 0, NULL};

...
+ (CCPBVActionPath *)fromStringWithNSString:(NSString *)path {
  ...
  CCPBVActionPath *p = [[CCPBVActionPath alloc] initWithInt:len];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _CCPBVActionPath = { "ActionPath", "com.sparseware.bellavista", NULL, 0x1, 11, methods, 1, fields, 1, superclass_type_args};

...
#ifndef _CCPBVSummaryVitalsHandler_H_
#define _CCPBVSummaryVitalsHandler_H_
...
@interface CCPBVSummaryVitalsHandler : CCPBVaEventHandler {
}
...
typedef CCPBVSummaryVitalsHandler ComSparsewareBellavistaSummaryVitalsHandler;

@interface CCPBVSummaryVitalsHandler_VitalRange : NSObject {
 @public
  NSString *name_;
  float high_;
  float low_;
...
J2OBJC_FIELD_SETTER(CCPBVSummaryVitalsHandler_VitalRange, name_, NSString *)
J2OBJC_FIELD_SETTER(CCPBVSummaryVitalsHandler_VitalRange, series_, RAREChartDataItem *)
J2OBJC_FIELD_SETTER(CCPBVSummaryVitalsHandler_VitalRange, chart_, RAREChartViewer *)

@interface CCPBVSummaryVitalsHandler_BPVitalRange : CCPBVSummaryVitalsHandler_VitalRange {
 @public
...
J2OBJC_FIELD_SETTER(CCPBVSummaryVitalsHandler_BPVitalRange, bpSeries_, RAREChartDataItem *)

#endif // _CCPBVSummaryVitalsHandler_H_

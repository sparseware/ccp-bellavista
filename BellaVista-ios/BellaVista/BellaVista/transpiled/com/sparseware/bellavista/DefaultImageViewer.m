...
@implementation ComSparsewareBellavistaDefaultImageViewer

static int ComSparsewareBellavistaDefaultImageViewer_THUMBNAIL_URL_POSITION_ = 2;
static int ComSparsewareBellavistaDefaultImageViewer_IMAGE_URL_POSITION_ = 3;

+ (int)THUMBNAIL_URL_POSITION {
  return ComSparsewareBellavistaDefaultImageViewer_THUMBNAIL_URL_POSITION_;
}
...
+ (int)IMAGE_URL_POSITION {
  return ComSparsewareBellavistaDefaultImageViewer_IMAGE_URL_POSITION_;
}
...
withComSparsewareBellavistaDocument_DocumentItem:(ComSparsewareBellavistaDocument_DocumentItem *)attachment
  ...
  RAREaWorkerTask *task = [[ComSparsewareBellavistaDefaultImageViewer_$1 alloc] initWithComSparsewareBellavistaDefaultImageViewer:self withRAREiFunctionCallback:cb withRAREWindowViewer:w withRAREiContainer:parent withComSparsewareBellavistaDocument_DocumentItem:attachment withComSparsewareBellavistaDocument:document];
...
- (void)stateChangedWithJavaUtilEventObject:(JavaUtilEventObject *)e {
  ...
  if (item != nil) {
    NSString *src = (NSString *) check_class_cast([((RARERenderableDataItem *) nil_chk([item getWithInt:ComSparsewareBellavistaDefaultImageViewer_IMAGE_URL_POSITION_])) getValue], [NSString class]);
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _ComSparsewareBellavistaDefaultImageViewer = { "DefaultImageViewer", "com.sparseware.bellavista", NULL, 0x1, 1, methods, 2, fields, 0, NULL};
  return &_ComSparsewareBellavistaDefaultImageViewer;
}

@end
@implementation ComSparsewareBellavistaDefaultImageViewer_$1
...
- (id)compute {
  @try {
    NSString *id_ = [((ComSparsewareBellavistaDocument *) nil_chk(val$document_)) getID];
    RAREActionLink *link = [ComSparsewareBellavistaUtils createLinkWithRAREiWidget:val$w_ withNSString:[NSString stringWithFormat:@"/hub/main/imaging/thumbnails/%@", id_] withBoolean:NO];
    ...
    for (RARERenderableDataItem * __strong item in nil_chk(list)) {
      [item setValueWithId:[((RARERenderableDataItem *) nil_chk([((RARERenderableDataItem *) nil_chk(item)) getWithInt:[ComSparsewareBellavistaDefaultImageViewer THUMBNAIL_URL_POSITION]])) getValue]];
    }
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "this$0_", NULL, 0x1012, "LComSparsewareBellavistaDefaultImageViewer" },
    { "val$cb_", NULL, 0x1012, "LRAREiFunctionCallback" },
    { "val$w_", NULL, 0x1012, "LRAREWindowViewer" },
    { "val$parent_", NULL, 0x1012, "LRAREiContainer" },
    { "val$attachment_", NULL, 0x1012, "LComSparsewareBellavistaDocument_DocumentItem" },
    { "val$document_", NULL, 0x1012, "LComSparsewareBellavistaDocument" },
  };
  static J2ObjcClassInfo _ComSparsewareBellavistaDefaultImageViewer_$1 = { "$1", "com.sparseware.bellavista", "DefaultImageViewer", 0x8000, 1, methods, 6, fields, 0, NULL};
  return &_ComSparsewareBellavistaDefaultImageViewer_$1;
}

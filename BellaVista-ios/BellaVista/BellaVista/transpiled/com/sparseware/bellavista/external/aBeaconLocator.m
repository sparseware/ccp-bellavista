...
- (void)stateChangedWithJavaUtilEventObject:(JavaUtilEventObject *)e {
  ...
  switch ([[((CCPBVaPatientLocator_LocatorChangeEvent *) nil_chk(ce)) getChangeType] ordinal]) {
    ...
    return;
    default:
    [self fireStateChangedWithCCPBVaPatientLocator_LocatorChangeEvent:ce];
    break;
  }
  if (list != nil) {
    ...
    [self fireStateChangedWithCCPBVaPatientLocator_LocatorChangeEvent:lce];
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "fireStateChangedWithCCPBVaPatientLocator_LocatorChangeEvent:", NULL, "V", 0x4, NULL },
...
- (void)run {
  [this$0_ fireStateChangedWithCCPBVaPatientLocator_LocatorChangeEvent:[[CCPBVaPatientLocator_LocatorChangeEvent alloc] initWithId:self withCCPBVaPatientLocator_LocatorChangeTypeEnum:[CCPBVaPatientLocator_LocatorChangeTypeEnum ACCESS_DENIED]]];
}

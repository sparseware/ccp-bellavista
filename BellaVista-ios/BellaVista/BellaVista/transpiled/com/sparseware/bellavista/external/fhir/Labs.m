...
- (BOOL)processObservationEntryWithNSString:(NSString *)date
  ...
  do {
    ...
    if (((CCPBVFHIRFHIRServer *) nil_chk(server_))->debug_ && labld != nil && lab != nil && ![((JavaUtilHashSet *) nil_chk(uniqueDates_)) addWithId:[NSString stringWithFormat:@"%@-%@", date, labld]]) {
      lab = [NSString stringWithFormat:@"{fgColor:badData}DUPLICATE: %@", lab];
    }
    if (jw != nil) {
      (void) [jw object];
      if (date != nil) {

...
+ (RAREUTJSONObject *)populateUserWithNSString:(NSString *)id_
  ...
  RAREUTJSONObject *name = [((RAREUTJSONObject *) nil_chk(practioner)) getJSONObjectWithNSString:@"name"];
  ...
  s = [practioner optStringWithNSString:@"sub"];
  if (s != nil) {
    (void) [o putWithNSString:@"username" withId:s];
  }
  (void) [o putWithNSString:@"gender" withId:[practioner optStringWithNSString:@"gender"]];
  (void) [o putWithNSString:@"dob" withId:[practioner optStringWithNSString:@"birthDate"]];
  (void) [o putWithNSString:@"id" withId:id_];
  [CCPBVFHIRFHIRUtils populateTelcomWithRAREUTJSONArray:[practioner optJSONArrayWithNSString:@"telecom"] withRAREUTJSONObject:o];
  RAREUTJSONArray *a = [practioner optJSONArrayWithNSString:@"address"];
  if (a != nil) {
  ...
  a = [practioner optJSONArrayWithNSString:@"practitionerRole"];
  int len = (a == nil) ? 0 : [a length];
  for (int i = 0; i < len; i++) {
    NSString *role;
    @try {

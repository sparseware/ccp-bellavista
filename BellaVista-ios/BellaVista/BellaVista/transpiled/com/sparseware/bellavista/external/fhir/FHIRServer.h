...
- (RAREUTJSONObject *)resolveUserInfoWithRAREUTJSONObject:(RAREUTJSONObject *)o;
...
J2OBJC_FIELD_SETTER(CCPBVFHIRFHIRServer_AuthHandler, userinfoUri_, NSString *)

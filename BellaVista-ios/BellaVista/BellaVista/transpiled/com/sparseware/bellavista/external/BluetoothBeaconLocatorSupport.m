  ...
  if (granted) {
    for (CCPBVBluetoothBeaconLocatorSupport_Monitor * __strong m in nil_chk(monitors_)) {
      if (((CCPBVBluetoothBeaconLocatorSupport_Monitor *) nil_chk(m))->monitoring_) {
        if (m->type_ == [CCPBVaPatientLocator_LocatorChangeTypeEnum PATIENTS] && listeningForPatients_) {
          [self startMonitoringWithJavaUtilList:m->beacons_];
        }
        else if (m->type_ == [CCPBVaPatientLocator_LocatorChangeTypeEnum LOCATIONS] && listeningForLocations_) {
          [self startMonitoringWithJavaUtilList:m->beacons_];
        }
      }
    }
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { "requestAuthorization", NULL, "V", 0x100, NULL },
    { "createProxyWithCCPBVBluetoothBeaconLocatorSupport:", NULL, "LNSObject", 0x108, NULL },
  };
  static J2ObjcFieldInfo fields[] = {
    { "monitorProxy_", NULL, 0x0, "LNSObject" },
    { "listeningForPatients_", NULL, 0x0, "Z" },
    { "listeningForLocations_", NULL, 0x0, "Z" },
    { "monitors_", NULL, 0x0, "LJavaUtilArrayList" },
  };
  static J2ObjcClassInfo _CCPBVBluetoothBeaconLocatorSupport = { "BluetoothBeaconLocatorSupport", "com.sparseware.bellavista.external", NULL, 0x1, 18, methods, 4, fields, 0, NULL};

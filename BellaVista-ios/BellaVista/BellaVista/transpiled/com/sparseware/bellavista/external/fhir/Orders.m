...
- (void)listWithCCPBViHttpConnection:(id<CCPBViHttpConnection>)conn
  ...
  RAREActionLink *l;
  if (searchParams_ != nil) {
    l = [self createSearchLinkWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"patient", [((CCPBVFHIRFHIRServer *) nil_chk(server_)) getPatientID] } count:2 type:[IOSClass classWithClass:[NSString class]]]];
  }
  else {
    l = [self createSearchLinkWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ @"patient", [((CCPBVFHIRFHIRServer *) nil_chk(server_)) getPatientID], @"status", @"active" } count:4 type:[IOSClass classWithClass:[NSString class]]]];
  }
  @try {

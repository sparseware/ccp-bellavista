 ...
 * level events generated by the runtime
 *
 * @author Don DeCoteau
 *
 */
public class ApplicationListener implements iApplicationListener, iConfigurationListener {
  ...
  public void applicationInitialized(iPlatformAppContext app) {
    ...
    SmartDateContext dc=new SmartDateContext(true,app.getDefaultDateTimeContext().getDisplayFormat());
    app.setDefaultDateTimeContext(dc);
    dc=new SmartDateContext(false,app.getDefaultDateContext().getDisplayFormat());
    app.setDefaultDateContext(dc);

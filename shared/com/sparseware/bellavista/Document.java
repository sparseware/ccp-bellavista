...
public class Document extends aWorkerTask {
  ...
  static void staticInitialize() throws Exception {
    documentViewerCfg =
      (GridPane) Platform.getWindowViewer().createConfigurationObject(new ActionLink("/document_viewer.rml"));
  ...
  public void finish(Object result) {
    if (callback != null) {
      callback.finished(result != null, (result == null)
                                        ? this
                                        : result);
      callback = null;
    }
  ...
  static class AttachmentActionListener implements iActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (lastActionTime + 500 < time) { //prevent double tap from triggering twice
        lastActionTime=time;
        final WindowViewer w     = Platform.getWindowViewer();

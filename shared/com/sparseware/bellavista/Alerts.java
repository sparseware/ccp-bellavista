...
public class Alerts extends aEventHandler {
  ...
  public static iPlatformIcon getAlertCountIcon() {
    ...
    if (alertCountIcon == null) {
      ...
      b.setInsetsPadding(UIScreen.PLATFORM_PIXELS_2, UIScreen.PLATFORM_PIXELS_2, UIScreen.PLATFORM_PIXELS_2, UIScreen.PLATFORM_PIXELS_2);

...
public class CollectionManager implements Runnable {
  ...
  public CollectionManager() {
    ...
    int keepalive = csp == null ? 99999 : csp.optInt("keepalive_interval", 99999);
    keepalive *= 1000;
    ...
    info = (JSONObject) Platform.getAppContext().getData("patientSelectInfo");
    list = (JSONArray) info.getJSONArray("listCategories");
    len = list == null ? 0 : list.size();
  ...
  public iDataCollection getCollection(String name) {
    ...
    return (iDataCollection) (o == null ? null : o.get("_dc"));
  }
